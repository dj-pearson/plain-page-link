import { j as jsxRuntimeExports, L as Link, l as useSearchParams, g as useNavigate, r as reactExports } from "./react-vendor-MTOt5FFF.js";
import { u as useAnalytics } from "./useAnalytics-D66O6y04.js";
...
import { C as Card, f as CardHeader, g as CardTitle, h as CardDescription, v as Progress, o as CardContent, u as LoadingSpinner, D as Dialog, l as DialogContent, m as DialogHeader, n as DialogTitle, G as DialogDescription } from "./ui-components-CbrOUI4e.js";
import { u as useListings } from "./useListings-Dh7P6Y-u.js";
import { u as useTestimonials } from "./useTestimonials-De3d3LFZ.js";
import { c as CircleAlert, at as Circle, J as CircleCheckBig, E as Eye, U as Users, au as MousePointerClick, T as TrendingUp, ae as Copy, h as ExternalLink, av as PartyPopper, b as Check } from "./icons-CFSiufIk.js";
...
function ProfileCompletionWidget() {
  ...
  const steps = [
    ...
    },
    {
      ...
      completed: ((listings == null ? void 0 : listings.length) || 0) > 0,
    ...
    },
    {
      ...
      completed: ((testimonials == null ? void 0 : testimonials.length) || 0) > 0,
    ...
    },
    {
      ...
      completed: ((links == null ? void 0 : links.length) || 0) > 0,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 space-y-2", children: steps.map((step) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Link,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-medium ".concat(step.completed ? "text-gray-500 line-through" : "text-gray-900"), children: step.label }),
...
function Overview() {
  ...
  const isNewUser = (profile == null ? void 0 : profile.created_at) ? (/* @__PURE__ */ new Date()).getTime() - new Date(profile.created_at).getTime() < 48 * 60 * 60 * 1e3 : false;
  ...
  const getUnlockedFeatures = (planName) => {
    ...
    return features[(planName == null ? void 0 : planName.toLowerCase()) || "starter"] || [];
  };
  if (isLoading) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 sm:space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-2xl sm:text-3xl font-bold text-gray-900 mb-1 sm:mb-2", children: [
        greeting,
        (profile == null ? void 0 : profile.full_name) && !isNewUser && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-gray-600", children: [
          ", ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: recentLeads.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2 sm:space-y-3", children: recentLeads.slice(0, 5).map((lead) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between py-2 sm:py-2.5 border-b border-border last:border-0 gap-2 min-h-[44px]", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-2 py-1 text-xs rounded-full flex-shrink-0 font-medium ".concat(lead.status === "new" ? "bg-blue-100 text-blue-700" : lead.status === "contacted" ? "bg-yellow-100 text-yellow-700" : "bg-green-100 text-green-700"), children: lead.status })
          ...
          (profile == null ? void 0 : profile.username) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-2 p-2 bg-muted rounded-lg max-w-xs mx-auto", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              {
                onClick: async () => {
                  await navigator.clipboard.writeText("".concat(window.location.origin, "/").concat(profile.username));
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: showSuccessModal, onOpenChange: setShowSuccessModal, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "sm:max-w-md", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogTitle, { className: "text-center text-2xl", children: [
          "🎉 Welcome to ",
          subscription == null ? void 0 : subscription.plan_name,
          "!"
        ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-muted/50 rounded-lg p-4 my-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: getUnlockedFeatures(subscription == null ? void 0 : subscription.plan_name).map((feature, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2 text-sm", children: [
