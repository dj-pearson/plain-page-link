...
var Mutation = (_g = class extends Removable {
  ...
  async execute(variables) {
    var _a2, _b2, _c2, _d2, _e2, _f2, _g2, _h2, _i2, _j2, _k2, _l, _m, _n, _o, _p, _q, _r, _s, _t, _u;
    const onContinue = () => {
    ...
    try {
      if (restored) {
        ...
        const context = await ((_e2 = (_d2 = this.options).onMutate) == null ? void 0 : _e2.call(
          _d2,
          variables,
          mutationFnContext
        ));
      ...
      await ((_i2 = (_h2 = this.options).onSuccess) == null ? void 0 : _i2.call(
        _h2,
        data,
        variables,
        this.state.context,
      ...
      await ((_k2 = (_j2 = __privateGet(this, _mutationCache).config).onSettled) == null ? void 0 : _k2.call(
        _j2,
        data,
        null,
