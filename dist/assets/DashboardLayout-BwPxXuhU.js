import { u as useLocation, g as useNavigate, r as reactExports, j as jsxRuntimeExports, L as Link, O as Outlet } from './react-vendor-a6jLNMWt.js';
import { u as useAuthStore } from './state-stores-BQHzCYsU.js';
import { c as cn, D as Dialog, l as DialogContent, m as DialogHeader, n as DialogTitle, B as Badge, j as Button } from './ui-components-DLW4dShh.js';
import { H as Home, al as ListTodo, U as Users, B as BarChart3, $ as Menu, i as Star, a7 as Link$1, Z as Zap, aj as FileText, a0 as User, am as Palette, an as Settings, h as ExternalLink, ao as Shield, ap as LogOut, aq as LayoutDashboard, m as Building2, b as Check, ae as Copy, u as Share2 } from './icons-Bf8A6sFa.js';
          ...
          Link,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
                ...
                item.badge && item.badge > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -top-2 -right-2 bg-red-500 text-white text-xs rounded-full w-5 h-5 flex items-center justify-center font-semibold animate-pulse", "aria-label": `${item.badge} unread`, children: item.badge > 99 ? "99+" : item.badge })
              ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:ml-64 min-h-screen", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "bg-white border-b border-gray-200 sticky top-0 z-30 safe-area-inset-top", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between gap-2 sm:gap-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 sm:gap-3 flex-shrink-0", children: [
          profile?.username && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                variant: "outline",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 sm:w-10 sm:h-10 bg-blue-100 rounded-full flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm sm:text-base text-blue-600 font-semibold", children: getInitials(profile?.full_name) }) })
        ] })
      ] }) }),
