import { r as reactExports, g as useNavigate, j as jsxRuntimeExports } from './react-vendor-a6jLNMWt.js';
import { j as Button, v as Progress, C as Card } from './ui-components-DLW4dShh.js';
import { g as Sparkles, a6 as Upload, H as Home, E as Eye, a7 as Link, b as Check, a2 as ArrowLeft, A as ArrowRight, L as LoaderCircle } from './icons-Bf8A6sFa.js';
...
function OnboardingWizard({ onComplete, userProfile }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 py-8 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-8 bg-white shadow-xl", children: [
      ...
      currentStep === 5 && /* @__PURE__ */ jsxRuntimeExports.jsx(StepShare, { username: userProfile?.username || "yourname" })
    ] }),
...
export { OnboardingWizardPage as default };
