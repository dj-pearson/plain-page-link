;
(function () {
  System.register(['./react-vendor-legacy-BZejsv6W.js', './ui-components-legacy-oJhN_-ge.js', './icons-legacy-C8x4ypXf.js', './state-stores-legacy-80VekGrm.js', './supabase-legacy-CQONYrP8.js', './index-legacy-CvrXsObU.js', './charts-legacy-D2SqRQVB.js', './utils-legacy-B2316hnE.js', './data-legacy-BmYdDdMQ.js', './three-addons-legacy-COT_Kqtz.js', './three-legacy-VFAp7wzH.js', './forms-legacy-BImVIBp0.js'], function (exports, module) {
    'use strict';

    var reactExports, useNavigate, jsxRuntimeExports, Button, Progress, Card, Sparkles, Upload, Home, Eye, Link, Check, ArrowLeft, ArrowRight, LoaderCircle, useAuthStore, supabase, useToast;
    return {
      setters: [module => {
      ...
      execute: function () {
        exports("default", OnboardingWizardPage);
              ...
              children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                ...
                children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx("h1", {
                    ...
                    children: "Setup Your AgentBio Profile"
                  ...
                  children: steps.map(step => /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                    className: `flex items-center gap-2 ${step.number === currentStep ? "text-blue-600 font-semibold" : step.number < currentStep ? "text-green-600" : "text-gray-400"}`,
                    children: [step.number < currentStep ? /* @__PURE__ */jsxRuntimeExports.jsx("div", {
                      className: "w-8 h-8 rounded-full bg-green-500 flex items-center justify-center",
                      children: /* @__PURE__ */jsxRuntimeExports.jsx(Check, {
                        className: "h-5 w-5 text-white"
                      })
                    }) : /* @__PURE__ */jsxRuntimeExports.jsx("div", {
                      className: `w-8 h-8 rounded-full flex items-center justify-center ${step.number === currentStep ? "bg-blue-600 text-white" : "bg-gray-200 text-gray-500"}`,
                ...
                children: [currentStep === 1 && /* @__PURE__ */jsxRuntimeExports.jsx(StepChooseTemplate, {
                  templates,
                  selected: wizardData.templateChoice,
                  onSelect: id => setWizardData({
                    ...wizardData,
                    templateChoice: id
                  })
                }), currentStep === 2 && /* @__PURE__ */jsxRuntimeExports.jsx(StepProfileBasics, {
                  data: wizardData.profileBasics,
                  onChange: data => setWizardData({
                    ...wizardData,
                    profileBasics: data
                  })
                }), currentStep === 3 && /* @__PURE__ */jsxRuntimeExports.jsx(StepFirstListing, {
                  data: wizardData.firstListing,
                  onChange: data => setWizardData({
                    ...wizardData,
                    firstListing: data
                  })
                }), currentStep === 4 && /* @__PURE__ */jsxRuntimeExports.jsx(StepPreview, {
                  wizardData
                }), currentStep === 5 && /* @__PURE__ */jsxRuntimeExports.jsx(StepShare, {
                  username: userProfile?.username || "yourname"
                })]
                ...
                children: [/* @__PURE__ */jsxRuntimeExports.jsxs(Button, {
                  ...
                  children: ["Step ", currentStep, " of ", totalSteps, " • ~", 10 - currentStep * 2, " min remaining"]
                }), /* @__PURE__ */jsxRuntimeExports.jsxs(Button, {
                  onClick: handleNext,
                  disabled: !canProceed(),
                  children: [currentStep === totalSteps ? "Go to Dashboard" : "Next", /* @__PURE__ */jsxRuntimeExports.jsx(ArrowRight, {
        ...
        function StepChooseTemplate({
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
            children: [/* @__PURE__ */jsxRuntimeExports.jsx("h2", {
              ...
              children: "Select a template to match your brand. You can customize it later."
            }), /* @__PURE__ */jsxRuntimeExports.jsx("div", {
              className: "grid grid-cols-2 md:grid-cols-4 gap-4",
              children: templates.map(template => /* @__PURE__ */jsxRuntimeExports.jsxs("button", {
                onClick: () => onSelect(template.id),
                className: `p-4 rounded-xl border-2 transition-all ${selected === template.id ? "border-blue-600 bg-blue-50" : "border-gray-200 hover:border-gray-300"}`,
        ...
        function StepProfileBasics({
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
            children: [/* @__PURE__ */jsxRuntimeExports.jsx("h2", {
              className: "text-2xl font-bold mb-2",
              children: "Your Profile Basics"
            }), /* @__PURE__ */jsxRuntimeExports.jsx("p", {
              className: "text-gray-600 mb-6",
              children: "Add your photo and basic info. Takes ~2 minutes."
            }), /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
              className: "space-y-4",
              children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                children: [/* @__PURE__ */jsxRuntimeExports.jsx("label", {
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx("div", {
                    ...
                    children: data.photoPreview ? /* @__PURE__ */jsxRuntimeExports.jsx("img", {
        ...
        function StepFirstListing({
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
            children: [/* @__PURE__ */jsxRuntimeExports.jsx("h2", {
              ...
              className: "text-gray-600 mb-6",
              children: "Showcase a property to make your profile pop. You can skip and add later."
            }), /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
              className: "space-y-4",
              children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                children: [/* @__PURE__ */jsxRuntimeExports.jsx("label", {
                  ...
                  className: "flex items-center gap-4",
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx("div", {
                    className: "w-32 h-24 rounded-lg bg-gray-200 overflow-hidden",
                    children: data.photoPreview ? /* @__PURE__ */jsxRuntimeExports.jsx("img", {
                      src: data.photoPreview,
                      alt: "Property",
                      className: "w-full h-full object-cover"
        ...
        function StepPreview({
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
            children: [/* @__PURE__ */jsxRuntimeExports.jsx("h2", {
              ...
              className: "text-gray-600 mb-6",
              children: "Here's how your profile will look. You can edit everything later."
            }), /* @__PURE__ */jsxRuntimeExports.jsx("div", {
              ...
              children: /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                ...
                children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                  ...
                  children: [wizardData.profileBasics.photoPreview ? /* @__PURE__ */jsxRuntimeExports.jsx("img", {
                    ...
                    children: wizardData.profileBasics.fullName || "Your Name"
                  }), /* @__PURE__ */jsxRuntimeExports.jsx("p", {
                    className: "text-sm text-gray-600",
                    children: wizardData.profileBasics.title || "Your Title"
                  }), wizardData.profileBasics.location && /* @__PURE__ */jsxRuntimeExports.jsx("p", {
                    className: "text-sm text-gray-500",
                    children: wizardData.profileBasics.location
                  })]
                }), wizardData.profileBasics.bio && /* @__PURE__ */jsxRuntimeExports.jsx("p", {
                  className: "text-sm text-gray-700 text-center mb-4",
                  children: wizardData.profileBasics.bio
                }), wizardData.firstListing.photoPreview && /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx("img", {
                    ...
                    className: "p-4",
                    children: [/* @__PURE__ */jsxRuntimeExports.jsx("div", {
                      className: "font-semibold text-lg text-blue-600 mb-1",
                      children: wizardData.firstListing.price || "$XXX,XXX"
                    }), /* @__PURE__ */jsxRuntimeExports.jsx("div", {
                      className: "text-sm text-gray-700 mb-2",
                      children: wizardData.firstListing.address || "Property Address"
                    }), (wizardData.firstListing.beds || wizardData.firstListing.baths) && /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                      className: "text-sm text-gray-600",
                      children: [wizardData.firstListing.beds, " bd • ", wizardData.firstListing.baths, " ba"]
                    })]
                  })]
                })]
              })
        ...
        function StepShare({
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
            ...
            children: [/* @__PURE__ */jsxRuntimeExports.jsx("div", {
              ...
              className: "text-2xl font-bold mb-2",
              children: "🎉 Your Profile is Live!"
            }), /* @__PURE__ */jsxRuntimeExports.jsx("p", {
              className: "text-gray-600 mb-8",
              children: "Share your link on Instagram, Facebook, business cards, and everywhere you connect with clients."
            }), /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
              className: "bg-gradient-to-br from-blue-50 to-purple-50 rounded-xl p-6 mb-6",
              children: [/* @__PURE__ */jsxRuntimeExports.jsx("div", {
                className: "text-sm text-gray-600 mb-2",
                children: "Your AgentBio Link"
              }), /* @__PURE__ */jsxRuntimeExports.jsx("div", {
              ...
              children: [/* @__PURE__ */jsxRuntimeExports.jsx("h3", {
                ...
                children: [/* @__PURE__ */jsxRuntimeExports.jsx("div", {
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx("div", {
                    ...
                    children: "Add it to Instagram bio"
                  }), /* @__PURE__ */jsxRuntimeExports.jsx("div", {
                    className: "text-sm text-gray-600",
                    children: "Replace your current link with your AgentBio URL"
                  })]
                })]
              }), /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                className: "flex items-start gap-3",
                children: [/* @__PURE__ */jsxRuntimeExports.jsx("div", {
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx("div", {
                    className: "font-medium",
                    children: "Add more listings"
                  }), /* @__PURE__ */jsxRuntimeExports.jsx("div", {
                    className: "text-sm text-gray-600",
                    children: "Showcase your sold properties and active listings"
                  })]
                })]
              }), /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                className: "flex items-start gap-3",
                children: [/* @__PURE__ */jsxRuntimeExports.jsx("div", {
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx("div", {
                    ...
                    className: "text-sm text-gray-600",
                    children: "Match your personal brand with colors and fonts"
                  })]
                })]
              })]
            })]
        ...
        function OnboardingWizardPage() {
            ...
            try {
              ...
              if (wizardData.profileBasics.photo) {
                try {
                  ...
                  const {
                    error: uploadError
                  } = await supabase.storage.from("avatars").upload(filePath, wizardData.profileBasics.photo);
              ...
              if (wizardData.firstListing.address || wizardData.firstListing.price) {
                try {
                  ...
                  if (wizardData.firstListing.photo) {
                    ...
                    const {
                      error: uploadError
                    } = await supabase.storage.from("listing-images").upload(filePath, wizardData.firstListing.photo);
                    if (!uploadError) {
                      const {
                        data: {
                          publicUrl
                  ...
                  const addressParts = wizardData.firstListing.address?.split(",").map(s => s.trim()) || [];
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsx(OnboardingWizard, {
