...
import { H as Home, X, U as Users, e as Calendar, i as Star, T as TrendingUp, b as Check } from './icons-Bf8A6sFa.js';
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "min-h-screen bg-background", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-8 bg-background/95 border-b border-glass-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-4xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-base md:text-lg glass-body leading-relaxed", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "AgentBio is a specialized link-in-bio platform for real estate agents" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 bg-background/50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "text-center mb-16", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-4xl md:text-5xl font-light tracking-tight text-foreground mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "glass-heading", children: "Why Generic Link-in-Bio Tools Fail for Realtors" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl glass-body max-w-3xl mx-auto", children: "Linktree, Beacons, and other generic platforms weren't built for real estate. Here's what you're missing..." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-4xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-6 rounded-xl bg-glass-background backdrop-blur-md border border-glass-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4 mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "h-6 w-6 text-red-400 flex-shrink-0 mt-1" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-light text-foreground mb-2", children: "No Property Showcase" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "glass-body", children: "Generic tools can't display property listings with photos, pricing, beds/baths, and MLS details. You're limited to basic links that don't convert." })
            ] })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-6 rounded-xl bg-glass-background backdrop-blur-md border border-glass-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4 mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "h-6 w-6 text-red-400 flex-shrink-0 mt-1" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-light text-foreground mb-2", children: "Basic Lead Capture" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "glass-body", children: "Generic contact forms don't qualify leads. No buyer vs seller differentiation, no pre-qualification questions, no home valuation requests." })
            ] })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-6 rounded-xl bg-glass-background backdrop-blur-md border border-glass-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4 mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "h-6 w-6 text-red-400 flex-shrink-0 mt-1" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-light text-foreground mb-2", children: "No Appointment Booking" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "glass-body", children: "Without integrated calendar booking, you're playing phone tag with interested buyers instead of letting them self-schedule showings." })
            ] })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-6 rounded-xl bg-glass-background backdrop-blur-md border border-glass-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4 mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "h-6 w-6 text-red-400 flex-shrink-0 mt-1" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-light text-foreground mb-2", children: "No Social Proof" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "glass-body", children: "Can't showcase testimonials, sold properties, or client reviews—missing crucial trust signals that convert followers into clients." })
            ] })
          ] }) })
        ] }) })
      ] }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 bg-background/50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "text-center mb-12", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-4xl md:text-5xl font-light tracking-tight text-foreground mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "glass-heading", children: "AgentBio vs Generic Link Tools" }) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-4xl mx-auto overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full border-collapse", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-glass-border", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left p-4 glass-body font-light", children: "Feature" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-center p-4 glass-body font-light", children: "AgentBio" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-center p-4 glass-body font-light", children: "Linktree" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-center p-4 glass-body font-light", children: "Beacons" })
          ] }) }),
          ...
          ].map((row, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-glass-border/50", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4 glass-body", children: row.feature }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "text-center p-4", children: typeof row.agentbio === "boolean" ? row.agentbio ? /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "h-5 w-5 text-green-400 mx-auto" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "h-5 w-5 text-red-400 mx-auto" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "glass-body", children: row.agentbio }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "text-center p-4", children: typeof row.linktree === "boolean" ? row.linktree ? /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "h-5 w-5 text-green-400 mx-auto" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "h-5 w-5 text-red-400 mx-auto" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "glass-body text-muted-foreground", children: row.linktree }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "text-center p-4", children: typeof row.beacons === "boolean" ? row.beacons ? /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "h-5 w-5 text-green-400 mx-auto" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "h-5 w-5 text-red-400 mx-auto" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "glass-body text-muted-foreground", children: row.beacons }) })
          ] }, i)) })
        ] }) })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-4xl md:text-5xl font-light tracking-tight mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "glass-heading", children: "Ready to Upgrade from Generic Links?" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl mb-8 glass-body max-w-2xl mx-auto", children: "Join 5,000+ real estate agents using AgentBio to convert social media traffic into qualified leads" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Link,
          {
            to: "/auth/register",
...
export { ForRealEstateAgents as default };
