...
import { J as Tabs, K as TabsList, M as TabsTrigger, N as TabsContent } from "./ui-components-CbrOUI4e.js";
import { aE as Save, aF as Camera, aw as Plus, X } from "./icons-CFSiufIk.js";
...
function useAvatarUpload() {
  ...
  const uploadAvatar = async (file) => {
    ...
    try {
      ...
      const fileName = "".concat(user.id, "/avatar.").concat(fileExt);
      const { data: existingFiles } = await supabase.storage.from("avatars").list(user.id);
      if (existingFiles && existingFiles.length > 0) {
        await supabase.storage.from("avatars").remove(existingFiles.map((f) => "".concat(user.id, "/").concat(f.name)));
      }
...
function Profile() {
  ...
  const formatPhone = (value) => {
    ...
    if (cleaned.length <= 6) return "(".concat(cleaned.slice(0, 3), ") ").concat(cleaned.slice(3));
    return "(".concat(cleaned.slice(0, 3), ") ").concat(cleaned.slice(3, 6), "-").concat(cleaned.slice(6, 10));
  };
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-lg p-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
          ...
          ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-24 h-24 rounded-full bg-primary/10 flex items-center justify-center text-3xl font-bold text-primary", children: ((_a = formData.full_name) == null ? void 0 : _a.split(" ").map((n) => n[0]).join("")) || ((_c = (_b = formData.username) == null ? void 0 : _b[0]) == null ? void 0 : _c.toUpperCase()) || "?" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                ...
                onChange: handleChange,
                maxLength: 60,
                placeholder: "".concat(formData.full_name || "Your Name", " - Real Estate Agent"),
                className: "w-full px-4 py-2 bg-background border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mt-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-medium ".concat(formData.seo_title.length > 60 ? "text-red-600" : "text-muted-foreground"), children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "textarea",
              {
                ...
                maxLength: 160,
                rows: 3,
                placeholder: "Professional real estate services by ".concat(formData.full_name || "Your Name", ". Specializing in ").concat(formData.service_cities.join(", ") || "your area", ". Contact me today for all your real estate needs."),
                className: "w-full px-4 py-2 bg-background border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary resize-none"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mt-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-medium ".concat(formData.seo_description.length > 160 ? "text-red-600" : "text-muted-foreground"), children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-background border border-border rounded-lg p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-lg text-blue-600 hover:underline cursor-pointer font-medium line-clamp-1", children: formData.seo_title || "".concat(formData.full_name || "Your Name", " - Real Estate Agent") }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-muted-foreground line-clamp-2", children: formData.seo_description || "Professional real estate services by ".concat(formData.full_name || "Your Name", ". Contact me today for all your real estate needs.") })
            ] }) })
          ] }),
