  ...
  System.register(['./react-vendor-legacy-BZejsv6W.js'], function (exports, module) {
    ...
    return {
      ...
      execute: function () {
        ...
        const stringType = exports("s", ZodString.create);
        const booleanType = exports("b", ZodBoolean.create);
        ZodNever.create;
        ZodArray.create;
        const objectType = exports("o", ZodObject.create);
        ZodUnion.create;
