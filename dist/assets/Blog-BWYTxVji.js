...
import { x as Helmet, I as Input, S as Select, a as SelectTrigger, b as SelectValue, d as SelectContent, e as SelectItem, C as Card, f as CardHeader, g as CardTitle, h as CardDescription, B as Badge, i as CardFooter } from './ui-components-DLW4dShh.js';
import { P as PublicHeader, a as PublicFooter } from './index-Dww_DGvO.js';
import { B as Breadcrumbs } from './Breadcrumbs-BBWpKR2M.js';
import { S as Search, e as Calendar, E as Eye } from './icons-Bf8A6sFa.js';
...
function BlogListSEO({ totalArticles, latestArticleDate }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Helmet, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("meta", { property: "og:image", content: `${siteUrl}/Cover.png` }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("meta", { name: "twitter:image", content: `${siteUrl}/Cover.png` }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background flex flex-col", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 py-8", children: [
        ...
        isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "Loading articles..." }) }) : filteredArticles.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "No articles found" }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6", children: filteredArticles.map((article) => /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: `/blog/${article.slug}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "h-full hover:shadow-lg transition-shadow cursor-pointer", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
              ...
              article.tags?.slice(0, 2).map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "text-xs", children: tag }, tag))
            ] }),
