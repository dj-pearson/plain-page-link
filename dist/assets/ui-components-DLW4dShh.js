import { r as reactExports, R as React, j as jsxRuntimeExports, b as React$1, d as reactDomExports, e as ReactDOM } from './react-vendor-a6jLNMWt.js';
import { L as LoaderCircle, C as ChevronDown, a as ChevronUp, b as Check, X, c as CircleAlert, R as RefreshCcw, H as Home } from './icons-Bf8A6sFa.js';
import { g as getDefaultExportFromCjs } from './charts-DsEHo9_O.js';
import { t as twMerge, c as clsx } from './utils-BhOeSegx.js';
import { _ as __assign, b as __rest, c as __spreadArray } from './supabase-D4RJa1Op.js';
...
const LoadingSpinner$1 = ({ size = "md", className = "", text }) => {
  const sizeClasses = {
    sm: "w-4 h-4",
    md: "w-8 h-8",
    lg: "w-12 h-12"
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex flex-col items-center justify-center gap-2 ${className}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: `${sizeClasses[size]} animate-spin text-primary` }),
...
const PasswordStrengthIndicator = ({ password }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mt-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `text-xs font-medium ${strength <= 2 ? "text-red-600" : strength === 3 ? "text-yellow-600" : strength === 4 ? "text-blue-600" : "text-green-600"}`, children: getStrengthLabel(strength) }),
...
function LoadingSpinner({
  ...
  const spinner = /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: cn("animate-spin text-blue-600", sizeClasses[size], className) });
  if (fullScreen) {
...
export { TableRow as $, Avatar as A, Badge as B, Card as C, Dialog as D, ErrorBoundary as E, FullPageLoader as F, DialogDescription as G, HelmetProvider as H, Input as I, Tabs as J, TabsList as K, Label$1 as L, TabsTrigger as M, TabsContent as N, DialogFooter as O, PasswordStrengthIndicator as P, Alert as Q, AlertDescription as R, Select as S, Textarea as T, Popover as U, PopoverTrigger as V, PopoverContent as W, getCurrentTheme as X, DEFAULT_THEMES as Y, Table as Z, TableHeader as _, SelectTrigger as a, TableHead as a0, TableBody as a1, TableCell as a2, DropdownMenu as a3, DropdownMenuTrigger as a4, DropdownMenuContent as a5, DropdownMenuItem as a6, DialogTrigger as a7, SelectValue as b, cn as c, SelectContent as d, SelectItem as e, CardHeader as f, CardTitle as g, CardDescription as h, CardFooter as i, Button as j, SEOHead as k, DialogContent as l, DialogHeader as m, DialogTitle as n, CardContent as o, AvatarImage as p, AvatarFallback as q, hapticFeedback as r, applyTheme as s, LoadingSpinner$1 as t, LoadingSpinner as u, Progress as v, Switch as w, Helmet as x, Separator$1 as y, Checkbox as z };
