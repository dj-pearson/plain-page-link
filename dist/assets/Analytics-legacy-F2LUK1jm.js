;
(function () {
  System.register(['./react-vendor-legacy-BZejsv6W.js', './ui-components-legacy-oJhN_-ge.js', './charts-legacy-D2SqRQVB.js', './index-legacy-CvrXsObU.js', './icons-legacy-C8x4ypXf.js', './SearchAnalyticsDashboard-legacy-D-8Hg7WY.js', './useAnalytics-legacy-DIC4e8Jy.js', './utils-legacy-B2316hnE.js', './supabase-legacy-CQONYrP8.js', './data-legacy-BmYdDdMQ.js', './three-addons-legacy-COT_Kqtz.js', './three-legacy-VFAp7wzH.js', './state-stores-legacy-80VekGrm.js', './forms-legacy-BImVIBp0.js'], function (exports, module) {
    'use strict';

    var jsxRuntimeExports, reactExports, Card, CardHeader, CardTitle, cn, CardContent, CardDescription, Table, TableHeader, TableRow, TableHead, Button, TableBody, TableCell, Badge, Tabs, TabsList, TabsTrigger, TabsContent, ResponsiveContainer, LineChart, Line, BarChart, Bar, AreaChart, Area, CartesianGrid, XAxis, YAxis, Tooltip, Legend, formatRelativeTime, User, Mail, Phone, ChevronUp, ChevronDown, Calendar, Download, BarChart3, Search, Eye, Users, UserPlus, TrendingUp, SearchAnalyticsDashboard, useAnalytics;
    return {
      setters: [module => {
      ...
      execute: function () {
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs(Card, {
            children: [/* @__PURE__ */jsxRuntimeExports.jsxs(CardHeader, {
              ...
              children: [/* @__PURE__ */jsxRuntimeExports.jsx(CardTitle, {
                ...
                className: cn("rounded-full p-2", iconBgColor),
              ...
              children: [/* @__PURE__ */jsxRuntimeExports.jsx("div", {
                ...
                children: value
              }), change !== void 0 && /* @__PURE__ */jsxRuntimeExports.jsxs("p", {
                className: cn("text-xs font-medium mt-1", trendColor),
                children: [trendSymbol, " ", Math.abs(change), "% ", changeLabel]
              })]
            })]
          });
        }
        function AnalyticsChart({
          ...
          const renderChart = () => {
            ...
            const chartElements = /* @__PURE__ */jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
            ...
            switch (type) {
              case "area":
                return /* @__PURE__ */jsxRuntimeExports.jsxs(AreaChart, {
                  ...commonProps,
                  children: [chartElements, series.map(s => /* @__PURE__ */jsxRuntimeExports.jsx(Area, {
                    type: "monotone",
                    dataKey: s.dataKey,
                    name: s.name,
                    stroke: s.color,
              ...
              case "bar":
                return /* @__PURE__ */jsxRuntimeExports.jsxs(BarChart, {
                  ...commonProps,
                  children: [chartElements, series.map(s => /* @__PURE__ */jsxRuntimeExports.jsx(Bar, {
                    dataKey: s.dataKey,
                    name: s.name,
                    fill: s.color,
                    radius: [4, 4, 0, 0]
              ...
              case "line":
              default:
                return /* @__PURE__ */jsxRuntimeExports.jsxs(LineChart, {
                  ...commonProps,
                  children: [chartElements, series.map(s => /* @__PURE__ */jsxRuntimeExports.jsx(Line, {
                    type: "monotone",
                    dataKey: s.dataKey,
                    name: s.name,
                    stroke: s.color,
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs(Card, {
            children: [/* @__PURE__ */jsxRuntimeExports.jsxs(CardHeader, {
              children: [/* @__PURE__ */jsxRuntimeExports.jsx(CardTitle, {
                children: title
              }), description && /* @__PURE__ */jsxRuntimeExports.jsx(CardDescription, {
        ...
        function LeadsTable({
          ...
          const SortIcon = ({
            ...
            return sortOrder === "asc" ? /* @__PURE__ */jsxRuntimeExports.jsx(ChevronUp, {
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs(Card, {
            children: [/* @__PURE__ */jsxRuntimeExports.jsxs(CardHeader, {
              children: [/* @__PURE__ */jsxRuntimeExports.jsx(CardTitle, {
                ...
                children: ["Your latest lead submissions (", leads.length, " total)"]
              })]
            }), /* @__PURE__ */jsxRuntimeExports.jsx(CardContent, {
              children: /* @__PURE__ */jsxRuntimeExports.jsx("div", {
                ...
                children: /* @__PURE__ */jsxRuntimeExports.jsxs(Table, {
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx(TableHeader, {
                    children: /* @__PURE__ */jsxRuntimeExports.jsxs(TableRow, {
                      children: [/* @__PURE__ */jsxRuntimeExports.jsx(TableHead, {
                        children: /* @__PURE__ */jsxRuntimeExports.jsxs(Button, {
                          ...
                          }), "Name", /* @__PURE__ */jsxRuntimeExports.jsx(SortIcon, {
                            field: "name"
                          })]
                        })
                        ...
                        children: /* @__PURE__ */jsxRuntimeExports.jsxs(Button, {
                          ...
                          className: "hover:bg-transparent",
                          children: ["Type", /* @__PURE__ */jsxRuntimeExports.jsx(SortIcon, {
                            field: "lead_type"
                          })]
                        })
                      }), /* @__PURE__ */jsxRuntimeExports.jsx(TableHead, {
                        children: /* @__PURE__ */jsxRuntimeExports.jsxs(Button, {
                          ...
                          className: "hover:bg-transparent",
                          children: ["Status", /* @__PURE__ */jsxRuntimeExports.jsx(SortIcon, {
                            field: "status"
                          })]
                        })
                      }), /* @__PURE__ */jsxRuntimeExports.jsx(TableHead, {
                        children: /* @__PURE__ */jsxRuntimeExports.jsxs(Button, {
                          ...
                          className: "hover:bg-transparent",
                          children: ["Date", /* @__PURE__ */jsxRuntimeExports.jsx(SortIcon, {
                            field: "created_at"
                          })]
                        })
                      }), /* @__PURE__ */jsxRuntimeExports.jsx(TableHead, {
                    ...
                    children: sortedLeads.length === 0 ? /* @__PURE__ */jsxRuntimeExports.jsx(TableRow, {
                    ...
                    }) : sortedLeads.map(lead => /* @__PURE__ */jsxRuntimeExports.jsxs(TableRow, {
                      ...
                      children: [/* @__PURE__ */jsxRuntimeExports.jsx(TableCell, {
                        ...
                        children: /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                          ...
                          }), lead.phone && /* @__PURE__ */jsxRuntimeExports.jsxs("a", {
                            href: `tel:${lead.phone}`,
                            className: "flex items-center text-blue-600 hover:underline",
                            onClick: e => e.stopPropagation(),
                        ...
                        children: /* @__PURE__ */jsxRuntimeExports.jsx(Badge, {
                          variant: "outline",
                          children: getLeadTypeLabel(lead.lead_type)
                        })
                      }), /* @__PURE__ */jsxRuntimeExports.jsx(TableCell, {
                        children: /* @__PURE__ */jsxRuntimeExports.jsx(Badge, {
                        ...
                        children: formatRelativeTime(lead.created_at)
                      }), /* @__PURE__ */jsxRuntimeExports.jsx(TableCell, {
                        className: "text-right",
            ...
            children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
              ...
              children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                children: [/* @__PURE__ */jsxRuntimeExports.jsx("h1", {
                  ...
                  children: "Track your profile performance, lead generation, and search visibility"
                })]
                ...
                children: [/* @__PURE__ */jsxRuntimeExports.jsxs(Button, {
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx(Calendar, {
                    ...
                    children: dateRange === "7d" ? "Last 7 days" : dateRange === "30d" ? "Last 30 days" : "Last 90 days"
                  })]
              ...
              children: [/* @__PURE__ */jsxRuntimeExports.jsxs(TabsList, {
                ...
                }), /* @__PURE__ */jsxRuntimeExports.jsx(AnalyticsChart, {
                  title: "Profile Views",
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsxs(Card, {
                    children: [/* @__PURE__ */jsxRuntimeExports.jsxs(CardHeader, {
                      ...
                      children: [/* @__PURE__ */jsxRuntimeExports.jsx(CardTitle, {
                        ...
                        children: "Leads by Type"
                      }), /* @__PURE__ */jsxRuntimeExports.jsx(CardDescription, {
                        className: "text-xs sm:text-sm",
                        children: "Distribution of lead inquiries"
                      })]
                    }), /* @__PURE__ */jsxRuntimeExports.jsx(CardContent, {
                      children: leadsData.length > 0 ? /* @__PURE__ */jsxRuntimeExports.jsx("div", {
                        className: "space-y-2 sm:space-y-3",
                        children: leadsData.map(item => /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                          ...
                          children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                            ...
                            children: [/* @__PURE__ */jsxRuntimeExports.jsxs("span", {
                              ...
                              children: [item.value, " leads"]
                            }), /* @__PURE__ */jsxRuntimeExports.jsxs("span", {
                              className: "text-xs sm:text-sm font-semibold min-w-[35px] text-right",
                              children: [stats.totalLeads > 0 ? (item.value / stats.totalLeads * 100).toFixed(0) : 0, "%"]
                            })]
                          })]
                        }, item.name))
                      }) : /* @__PURE__ */jsxRuntimeExports.jsx("p", {
                        className: "text-xs sm:text-sm text-muted-foreground text-center py-6 sm:py-8",
                    ...
                    children: [/* @__PURE__ */jsxRuntimeExports.jsxs(CardHeader, {
                      ...
                      children: [/* @__PURE__ */jsxRuntimeExports.jsx(CardTitle, {
                        ...
                        className: "text-xs sm:text-sm",
                        children: "Latest profile interactions"
                      })]
                    }), /* @__PURE__ */jsxRuntimeExports.jsx(CardContent, {
                      children: /* @__PURE__ */jsxRuntimeExports.jsx("div", {
                        className: "text-xs sm:text-sm text-muted-foreground text-center py-6 sm:py-8",
                        children: stats.totalViews > 0 ? `${stats.totalViews} profile views` : "No activity yet"
                      })
                    })]
                  })]
                }), /* @__PURE__ */jsxRuntimeExports.jsx(LeadsTable, {
                  leads: recentLeads,
