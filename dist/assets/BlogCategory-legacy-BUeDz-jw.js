...
(function () {
  System.register(['./react-vendor-legacy-BZejsv6W.js', './data-legacy-BmYdDdMQ.js', './supabase-legacy-CQONYrP8.js', './ui-components-legacy-oJhN_-ge.js', './index-legacy-CvrXsObU.js', './Breadcrumbs-legacy-D7s6hr2N.js', './icons-legacy-C8x4ypXf.js', './charts-legacy-D2SqRQVB.js', './utils-legacy-B2316hnE.js', './three-addons-legacy-COT_Kqtz.js', './three-legacy-VFAp7wzH.js', './state-stores-legacy-80VekGrm.js', './forms-legacy-BImVIBp0.js'], function (exports, module) {
    ...
    var useParams, reactExports, jsxRuntimeExports, Link, useQuery, supabase, Button, SEOHead, Input, Card, CardHeader, Badge, CardTitle, CardDescription, CardFooter, CardContent, PublicHeader, PublicFooter, Breadcrumbs, ArrowLeft, Search, Eye, Calendar;
    return {
      setters: [module => {
        useParams = module.f;
      ...
      execute: function () {
        ...
        function BlogCategory() {
          ...
          const {
            ...
            queryFn: async () => {
              ...
              const {
                data,
                error
              } = await supabase.from("articles").select("*").eq("status", "published").ilike("category", `%${categoryName}%`).order("published_at", {
                ascending: false
              });
          ...
          const filteredArticles = reactExports.useMemo(() => {
            ...
            return articles.filter(article => article.title.toLowerCase().includes(searchQuery.toLowerCase()) || article.excerpt?.toLowerCase().includes(searchQuery.toLowerCase()));
            ...
            children: [/* @__PURE__ */jsxRuntimeExports.jsx(SEOHead, {
              ...
              children: [/* @__PURE__ */jsxRuntimeExports.jsx(PublicHeader, {}), /* @__PURE__ */jsxRuntimeExports.jsx("div", {
                ...
                children: [/* @__PURE__ */jsxRuntimeExports.jsx("div", {
                  ...
                  children: /* @__PURE__ */jsxRuntimeExports.jsx("p", {
                    className: "text-muted-foreground",
                    children: searchQuery ? "No articles found matching your search." : "No articles in this category yet."
                  })
                }) : /* @__PURE__ */jsxRuntimeExports.jsx("div", {
                  className: "grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16",
                  children: filteredArticles.map(article => /* @__PURE__ */jsxRuntimeExports.jsxs(Card, {
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx("h2", {
                    ...
                    className: "space-y-4",
                    children: content.faqs.map((faq, index) => /* @__PURE__ */jsxRuntimeExports.jsx(FAQItem, {
