import { r as registerVersion, d as _registerComponent, C as Component, c as _getProvider, E as ErrorFactory, F as FirebaseError, g as getApp, f as getModularInstance, v as validateIndexedDBOpenable, h as isIndexedDBAvailable, j as areCookiesEnabled } from "./index.esm-CgUmPzY4.js";
...
const PACKAGE_VERSION = "w:".concat(version$1);
...
function getDbPromise$1() {
  if (!dbPromise$1) {
    dbPromise$1 = openDB$1(DATABASE_NAME$1, DATABASE_VERSION$1, {
...
async function waitForRegistrationActive(registration) {
  return new Promise((resolve, reject) => {
    const rejectTimeout = setTimeout(() => reject(new Error("Service worker not registered after ".concat(DEFAULT_REGISTRATION_TIMEOUT, " ms"))), DEFAULT_REGISTRATION_TIMEOUT);
