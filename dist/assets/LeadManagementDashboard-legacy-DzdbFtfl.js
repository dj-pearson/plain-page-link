...
(function () {
  System.register(['./react-vendor-legacy-BZejsv6W.js', './ui-components-legacy-oJhN_-ge.js', './icons-legacy-C8x4ypXf.js', './utils-legacy-B2316hnE.js', './charts-legacy-D2SqRQVB.js', './supabase-legacy-CQONYrP8.js'], function (exports, module) {
    ...
    var reactExports, jsxRuntimeExports, cn, Select, SelectTrigger, SelectValue, SelectContent, SelectItem, Input, Badge, Button, Dialog, DialogTrigger, DialogContent, DialogHeader, DialogTitle, Label, Textarea, Tabs, TabsList, TabsTrigger, TabsContent, Search, Mail, Phone, MapPin, Clock, TrendingUp, MessageSquare, Plus, Check, Copy, Pen, Trash2, Flame, X, Eye, ChevronRight, Calendar, Home, ExternalLink, Tag, formatDistanceToNow, ue, format;
    return {
      setters: [module => {
      ...
      execute: function () {
        exports("default", LeadManagementDashboard);
        function LeadInbox({
          leads,
          onLeadClick,
          onQuickReply,
          ...
          const filteredLeads = reactExports.useMemo(() => {
            ...
            return filtered;
          }, [leads, searchQuery, statusFilter, priorityFilter, sourceFilter, sortBy]);
          const stats = {
            total: leads.length,
            ...
            children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
              ...
              children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                children: [/* @__PURE__ */jsxRuntimeExports.jsx("h2", {
                  ...
                  children: [stats.new, " new leads • ", stats.hot, " hot • Avg score:", " ", stats.avgScore]
                })]
              ...
              children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                ...
                children: [/* @__PURE__ */jsxRuntimeExports.jsxs(Select, {
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx(SelectTrigger, {
                    ...
                    }), sources.map(source => /* @__PURE__ */jsxRuntimeExports.jsx(SelectItem, {
                      value: source,
                      children: source
                    }, source))]
                  })]
              ...
              className: "space-y-2",
              children: [filteredLeads.map(lead => /* @__PURE__ */jsxRuntimeExports.jsx(LeadCard, {
                lead,
                onClick: () => onLeadClick(lead),
                onQuickReply: () => onQuickReply(lead.id),
                onMarkAsRead: () => onMarkAsRead(lead.id)
              }, lead.id)), filteredLeads.length === 0 && /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
        ...
        function LeadCard({
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsx("div", {
            onClick,
            className: cn("relative p-4 rounded-lg border-2 transition-all cursor-pointer", "hover:shadow-md hover:border-gray-300", isUnread && "bg-blue-50 border-blue-200", !isUnread && "bg-white border-gray-200", isHot && "border-l-4 border-l-red-500"),
            children: /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
              ...
              children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                ...
                children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx("h3", {
                    className: cn("font-semibold truncate", isUnread && "text-primary"),
                    children: lead.name
                  }), isUnread && /* @__PURE__ */jsxRuntimeExports.jsx(Badge, {
                    variant: "outline",
                  ...
                  }), lead.phone && /* @__PURE__ */jsxRuntimeExports.jsxs("span", {
                    className: "flex items-center gap-1",
                ...
                }), lead.listingTitle && /* @__PURE__ */jsxRuntimeExports.jsxs("p", {
                  className: "text-xs text-gray-500",
                  children: ["Interested in:", " ", /* @__PURE__ */jsxRuntimeExports.jsx("span", {
                  ...
                  }), lead.lastContactedAt && /* @__PURE__ */jsxRuntimeExports.jsxs("span", {
                    children: ["Last contacted:", " ", formatDistanceToNow(new Date(lead.lastContactedAt), {
                      addSuffix: true
                    })]
                  })]
                })]
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
            ...
            children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
              ...
              children: [/* @__PURE__ */jsxRuntimeExports.jsx("h3", {
                ...
                children: "Quick Response Templates"
              }), onCreateTemplate && /* @__PURE__ */jsxRuntimeExports.jsxs(Dialog, {
                open: isCreating,
                ...
                children: [/* @__PURE__ */jsxRuntimeExports.jsx(DialogTrigger, {
                  ...
                  }), /* @__PURE__ */jsxRuntimeExports.jsx(TemplateForm, {
                    onSave: template => {
              ...
              children: filteredTemplates.map(template => /* @__PURE__ */jsxRuntimeExports.jsx(TemplateCard, {
                template,
            ...
            }), filteredTemplates.length === 0 && /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
            ...
            children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
              ...
              children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                ...
                }), onEdit && /* @__PURE__ */jsxRuntimeExports.jsx(Button, {
                  size: "sm",
                  variant: "ghost",
                ...
                }), onDelete && /* @__PURE__ */jsxRuntimeExports.jsx(Button, {
                  size: "sm",
                  variant: "ghost",
                  onClick: onDelete,
            ...
            }), template.variables.length > 0 && /* @__PURE__ */jsxRuntimeExports.jsx("div", {
              className: "flex flex-wrap gap-1 mb-3",
              children: template.variables.map(variable => /* @__PURE__ */jsxRuntimeExports.jsx(Badge, {
                variant: "outline",
                className: "text-xs",
                children: `{${variable}}`
              }, variable))
            ...
            }), isEditing && onEdit && /* @__PURE__ */jsxRuntimeExports.jsx(Dialog, {
              open: isEditing,
        ...
        function TemplateForm({
          ...
          const [subject, setSubject] = reactExports.useState(initialData?.subject || "");
          const [body, setBody] = reactExports.useState(initialData?.body || "");
          const [category, setCategory] = reactExports.useState(initialData?.category || "general");
          const handleSave = () => {
            ...
            children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
              ...
              children: [/* @__PURE__ */jsxRuntimeExports.jsx(Label, {
                ...
                children: [/* @__PURE__ */jsxRuntimeExports.jsx("option", {
                  ...
                  value: "showing",
                  children: "Property Showing"
                }), /* @__PURE__ */jsxRuntimeExports.jsx("option", {
                  value: "offer",
                  children: "Offer Discussion"
                }), /* @__PURE__ */jsxRuntimeExports.jsx("option", {
                  value: "general",
                  children: "General"
                })]
              ...
              children: [/* @__PURE__ */jsxRuntimeExports.jsx(Label, {
                ...
                children: ["Use curly braces for variables: ", "{leadName}", ",", " ", "{listingAddress}", ", ", "{price}"]
              })]
            }), /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
...
{agentPhone}`,
          category: "initial",
          variables: ["leadName", "listingAddress", "bedrooms", "bathrooms", "price", "feature1", "feature2", "feature3", "agentName", "agentPhone"]
        }, {
          id: "2",
...
{agentPhone}`,
          category: "showing",
          variables: ["leadName", "listingAddress", "showingDate", "showingTime", "agentName", "agentPhone"]
        }];
        function HotLeadAlert({
          ...
          const [dismissedLeads, setDismissedLeads] = reactExports.useState(/* @__PURE__ */new Set());
          reactExports.useEffect(() => {
            const newLeadIds = hotLeads.map(l => l.id);
            const currentVisible = new Set(visibleLeads);
            const newLeads = newLeadIds.filter(id => !currentVisible.has(id) && !dismissedLeads.has(id));
            if (newLeads.length > 0) {
              ue.success(`${newLeads.length} hot lead(s) just arrived!`, {
                icon: /* @__PURE__ */jsxRuntimeExports.jsx(Flame, {
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsx("div", {
            ...
            children: activeLeads.map(lead => /* @__PURE__ */jsxRuntimeExports.jsx(HotLeadCard, {
              lead,
        ...
        function HotLeadCard({
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
            className: cn("relative p-4 rounded-lg border-2 border-orange-500 bg-orange-50 shadow-lg", "animate-in slide-in-from-top-5 duration-300", isAnimating && "animate-pulse"),
            children: [/* @__PURE__ */jsxRuntimeExports.jsx("div", {
              className: "absolute -top-2 -right-2",
              children: /* @__PURE__ */jsxRuntimeExports.jsxs(Badge, {
                className: "bg-orange-600 text-white gap-1 animate-bounce",
                children: [/* @__PURE__ */jsxRuntimeExports.jsx(Flame, {
                  className: "w-3 h-3"
                }), "HOT LEAD"]
              })
            }), /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
              ...
              children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                ...
                children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                    ...
                    children: ["From: ", lead.source]
                  })]
                }), lead.listingTitle && /* @__PURE__ */jsxRuntimeExports.jsxs("p", {
                  className: "text-sm font-medium text-gray-900 mb-2",
                  children: ["Interested in: ", lead.listingTitle]
                }), /* @__PURE__ */jsxRuntimeExports.jsx("p", {
                  className: "text-sm text-gray-700 line-clamp-2 mb-2",
                  children: lead.message
                }), /* @__PURE__ */jsxRuntimeExports.jsxs("p", {
                  className: "text-xs text-gray-500",
                  children: ["Received", " ", formatDistanceToNow(new Date(lead.createdAt), {
                    addSuffix: true
                  })]
                })]
              }), /* @__PURE__ */jsxRuntimeExports.jsx("div", {
              ...
              children: [onQuickCall && lead.phone && /* @__PURE__ */jsxRuntimeExports.jsxs(Button, {
                size: "sm",
                onClick: onQuickCall,
                ...
                children: [/* @__PURE__ */jsxRuntimeExports.jsx(Eye, {
                  className: "w-4 h-4"
                }), "View Details", /* @__PURE__ */jsxRuntimeExports.jsx(ChevronRight, {
                  className: "w-4 h-4"
                })]
              })]
            }), /* @__PURE__ */jsxRuntimeExports.jsx("div", {
        ...
        function HotLeadIndicator({
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs(Button, {
            ...
            children: [/* @__PURE__ */jsxRuntimeExports.jsx(Flame, {
              ...
              className: "font-bold",
              children: [count, " Hot Lead", count > 1 ? "s" : ""]
            }), /* @__PURE__ */jsxRuntimeExports.jsx("div", {
        ...
        function LeadDetailView({
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsx("div", {
            className: cn("fixed inset-0 bg-black/50 z-50 overflow-y-auto", className),
            children: /* @__PURE__ */jsxRuntimeExports.jsx("div", {
              ...
              children: /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                ...
                children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                    ...
                    className: "mt-4 p-3 bg-gray-50 rounded-lg flex items-center justify-between",
                    children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                      ...
                      className: "text-sm text-gray-600",
                      children: ["Created", " ", formatDistanceToNow(new Date(lead.createdAt), {
                        addSuffix: true
                      })]
                    })]
                  }), /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                    ...
                    }), lead.phone && /* @__PURE__ */jsxRuntimeExports.jsxs(Button, {
                      variant: "outline",
                      className: "gap-2",
                    ...
                    }), onScheduleCall && /* @__PURE__ */jsxRuntimeExports.jsxs(Button, {
                      variant: "outline",
                      className: "gap-2",
                  ...
                  children: /* @__PURE__ */jsxRuntimeExports.jsx("div", {
                    ...
                    children: ["overview", "timeline", "notes"].map(tab => /* @__PURE__ */jsxRuntimeExports.jsx("button", {
                      onClick: () => setActiveTab(tab),
                      className: cn("py-3 px-1 border-b-2 font-medium text-sm capitalize transition-colors", activeTab === tab ? "border-primary text-primary" : "border-transparent text-gray-600 hover:text-gray-900"),
                      children: tab
                    }, tab))
                  })
                }), /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                  className: "p-6 max-h-[60vh] overflow-y-auto",
                  children: [activeTab === "overview" && /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                    className: "space-y-6",
                    children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                    ...
                    }), lead.listingTitle && /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                      children: [/* @__PURE__ */jsxRuntimeExports.jsxs("h3", {
                        className: "font-semibold mb-2 flex items-center gap-2",
                        ...
                        children: [lead.listingImage && /* @__PURE__ */jsxRuntimeExports.jsx("img", {
                          ...
                          children: [/* @__PURE__ */jsxRuntimeExports.jsx("p", {
                            ...
                            onClick: () => {},
                            children: ["View Listing", /* @__PURE__ */jsxRuntimeExports.jsx(ExternalLink, {
                              className: "w-3 h-3"
                            })]
                          })]
                        })]
                      })]
                    }), lead.tags && lead.tags.length > 0 && /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                      children: [/* @__PURE__ */jsxRuntimeExports.jsxs("h3", {
                        className: "font-semibold mb-2 flex items-center gap-2",
                        ...
                        children: lead.tags.map(tag => /* @__PURE__ */jsxRuntimeExports.jsx(Badge, {
                          variant: "outline",
                          children: tag
                        }, tag))
                      })]
                    })]
                  }), activeTab === "timeline" && /* @__PURE__ */jsxRuntimeExports.jsx("div", {
                    className: "space-y-4",
                    children: lead.timeline && lead.timeline.length > 0 ? lead.timeline.map(event => /* @__PURE__ */jsxRuntimeExports.jsx(TimelineItem, {
                      event
                    }, event.id)) : /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                      className: "text-center py-8 text-gray-500",
                      children: [/* @__PURE__ */jsxRuntimeExports.jsx(Clock, {
                  ...
                  }), activeTab === "notes" && /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                    className: "space-y-4",
                    children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                      className: "space-y-2",
                    ...
                    }), lead.notes && /* @__PURE__ */jsxRuntimeExports.jsx("div", {
                      className: "p-4 bg-gray-50 rounded-lg",
                      children: /* @__PURE__ */jsxRuntimeExports.jsx("p", {
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
            ...
            children: [/* @__PURE__ */jsxRuntimeExports.jsx("div", {
              ...
              children: [/* @__PURE__ */jsxRuntimeExports.jsx("p", {
                ...
                className: "text-xs text-gray-500 mt-1",
                children: [format(new Date(event.timestamp), "MMM d, yyyy 'at' h:mm a"), event.user && ` • ${event.user}`]
              })]
            })]
          });
        }
        const mockLeads = [{
          ...
          // 5 hours ago
          lastContactedAt: new Date(Date.now() - 1e3 * 60 * 60 * 3).toISOString()
        }, {
          id: "5",
          name: "Lisa Anderson",
        ...
        function LeadManagementDashboard() {
          ...
          const hotLeads = leads.filter(lead => lead.score >= 70 && lead.status === "new");
          const stats = {
            total: leads.length,
            new: leads.filter(l => l.status === "new").length,
            hot: hotLeads.length,
          ...
          const handleSelectTemplate = template => {
            ...
            body = body.replace("{listingAddress}", selectedLead.listingTitle || "the property");
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
            ...
            children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
              ...
              children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                children: [/* @__PURE__ */jsxRuntimeExports.jsx("h1", {
                  ...
                  children: "Manage your leads efficiently with smart scoring and quick responses"
                })]
              }), /* @__PURE__ */jsxRuntimeExports.jsx("div", {
                className: "flex gap-3",
                children: /* @__PURE__ */jsxRuntimeExports.jsx(HotLeadIndicator, {
            ...
            }), showHotLeads && hotLeads.length > 0 && /* @__PURE__ */jsxRuntimeExports.jsx(HotLeadAlert, {
              hotLeads,
              ...
              children: [/* @__PURE__ */jsxRuntimeExports.jsxs(TabsList, {
                ...
                children: [/* @__PURE__ */jsxRuntimeExports.jsxs(TabsTrigger, {
                  value: "inbox",
                  children: ["Lead Inbox", stats.new > 0 && /* @__PURE__ */jsxRuntimeExports.jsx(Badge, {
                    variant: "outline",
                ...
                value: "inbox",
                className: "mt-6",
                children: /* @__PURE__ */jsxRuntimeExports.jsx(LeadInbox, {
                  leads,
                ...
                value: "templates",
                className: "mt-6",
                children: /* @__PURE__ */jsxRuntimeExports.jsx(ResponseTemplates, {
                  templates,
            ...
            }), selectedLead && /* @__PURE__ */jsxRuntimeExports.jsx(LeadDetailView, {
              lead: selectedLead,
        ...
        function StatCard({
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
            ...
            children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
              ...
              children: [/* @__PURE__ */jsxRuntimeExports.jsx("div", {
                className: `p-2 rounded ${color ? colorClasses[color] : "bg-gray-100 text-gray-600"}`,
                children: icon
              }), pulse && /* @__PURE__ */jsxRuntimeExports.jsx("div", {
