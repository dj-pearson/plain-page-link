...
(function () {
  System.register(['./index.esm-legacy-Bq5xrBGm.js'], function (exports, module) {
    ...
    var registerVersion, _registerComponent, Component, _getProvider, ErrorFactory, FirebaseError, getApp, getModularInstance, validateIndexedDBOpenable, isIndexedDBAvailable, areCookiesEnabled;
    return {
      setters: [module => {
        ...
        ErrorFactory = module.E;
        FirebaseError = module.F;
        getApp = module.g;
        getModularInstance = module.f;
        validateIndexedDBOpenable = module.v;
        isIndexedDBAvailable = module.h;
        areCookiesEnabled = module.j;
      }],
      execute: function () {
        exports({
