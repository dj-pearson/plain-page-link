import { f as useParams, r as reactExports, j as jsxRuntimeExports, L as Link } from "./react-vendor-MTOt5FFF.js";
import { u as useQuery } from "./data-kszmrHwg.js";
import { s as supabase } from "./supabase-eNUZs_JT.js";
import { j as Button, k as SEOHead, I as Input, C as Card, f as CardHeader, B as Badge, g as CardTitle, h as CardDescription, i as CardFooter, o as CardContent } from "./ui-components-CbrOUI4e.js";
import { P as PublicHeader, a as PublicFooter } from "./index-CAwD2FR9.js";
import { B as Breadcrumbs } from "./Breadcrumbs-EhxiyXqZ.js";
import { a2 as ArrowLeft, S as Search, E as Eye, e as Calendar } from "./icons-CFSiufIk.js";
...
function BlogCategory() {
  ...
  const { data: articles = [], isLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      const { data, error } = await supabase.from("articles").select("*").eq("status", "published").ilike("category", "%".concat(categoryName, "%")).order("published_at", { ascending: false });
  ...
  const filteredArticles = reactExports.useMemo(() => {
    ...
    return articles.filter(
      (article) => {
        var _a;
        return article.title.toLowerCase().includes(searchQuery.toLowerCase()) || ((_a = article.excerpt) == null ? void 0 : _a.toLowerCase().includes(searchQuery.toLowerCase()));
      }
    );
  ...
  if (!content) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-background flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold mb-4", children: "Category Not Found" }),
  ...
  const schema = {
    ...
    "@graph": [
      {
        "@type": "CollectionPage",
        "@id": "https://agentbio.net/blog/category/".concat(category, "#webpage"),
        "url": "https://agentbio.net/blog/category/".concat(category),
        "name": content.title,
      ...
      },
      {
        ...
        "itemListElement": [
          ...
          },
          {
            ...
            "position": 3,
            "name": content.title,
            "item": "https://agentbio.net/blog/category/".concat(category)
          }
        ]
      },
      {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SEOHead,
      {
        title: "".concat(content.title, " | AgentBio Blog"),
        description: content.metaDescription,
        keywords: content.keywords,
        canonicalUrl: "https://agentbio.net/blog/category/".concat(category),
        schema
      }
    ),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-gradient-to-br from-blue-50 to-purple-50 border-b", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          Breadcrumbs,
          {
            items: [
              { name: "Blog", href: "/blog" },
              { name: content.title, href: "/blog/category/".concat(category) }
            ]
          }
        ) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/blog", className: "inline-flex items-center text-sm text-muted-foreground hover:text-foreground mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowLeft, { className: "h-4 w-4 mr-1" }),
          "Back to All Articles"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl md:text-5xl font-bold text-gray-900 mb-4", children: content.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-gray-600 leading-relaxed", children: content.description })
      ] }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 py-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-md mb-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
        ...
        isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "Loading articles..." }) }) : filteredArticles.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: searchQuery ? "No articles found matching your search." : "No articles in this category yet." }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16", children: filteredArticles.map((article) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "flex flex-col hover:shadow-lg transition-shadow", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardFooter, { className: "mt-auto flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm text-muted-foreground flex items-center gap-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { className: "h-4 w-4" }),
              new Date(article.published_at).toLocaleDateString()
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/blog/".concat(article.slug), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "ghost", size: "sm", children: "Read More →" }) })
          ] })
        ] }, article.id)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto mt-16 pt-16 border-t", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-bold text-center mb-8", children: "Frequently Asked Questions" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: content.faqs.map((faq, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(FAQItem, { question: faq.question, answer: faq.answer }, index)) })
        ] })
      ] }),
