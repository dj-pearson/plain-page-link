...
import { C as Card, f as CardHeader, g as CardTitle, c as cn, o as CardContent, h as CardDescription, Z as Table, _ as TableHeader, $ as TableRow, a0 as TableHead, j as Button, a1 as TableBody, a2 as TableCell, B as Badge, J as Tabs, K as TabsList, M as TabsTrigger, N as TabsContent } from "./ui-components-CbrOUI4e.js";
import { R as ResponsiveContainer, L as LineChart, b as Line, B as BarChart, d as Bar, A as AreaChart, e as Area, C as CartesianGrid, X as XAxis, Y as YAxis, T as Tooltip, f as Legend } from "./charts-BvRX79AF.js";
import { f as formatRelativeTime } from "./index-CAwD2FR9.js";
import { a0 as User, M as Mail, P as Phone, a as ChevronUp, C as ChevronDown, e as Calendar, a1 as Download, B as BarChart3, S as Search, E as Eye, U as Users, aK as UserPlus, T as TrendingUp } from "./icons-CFSiufIk.js";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-md border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: sortedLeads.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(TableRow, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        TableRow,
        {
          ...
          onClick: () => onLeadClick == null ? void 0 : onLeadClick(lead),
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-right", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                onClick: (e) => {
                  e.stopPropagation();
                  onLeadClick == null ? void 0 : onLeadClick(lead);
                },
                children: "View"
              }
            ) })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "overview", className: "space-y-4 sm:space-y-6", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs sm:text-sm text-muted-foreground text-center py-6 sm:py-8", children: stats.totalViews > 0 ? "".concat(stats.totalViews, " profile views") : "No activity yet" }) })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          LeadsTable,
