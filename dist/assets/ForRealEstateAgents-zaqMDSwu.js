...
import { H as Home, X, U as Users, e as Calendar, i as Star, T as TrendingUp, b as Check } from "./icons-CFSiufIk.js";
...
function ForRealEstateAgents() {
  const schema = {
    ...
    "@graph": [
      {
        "@type": "WebPage",
        "@id": "".concat(window.location.origin, "/for-real-estate-agents"),
        "url": "".concat(window.location.origin, "/for-real-estate-agents"),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SEOHead,
      {
        ...
        canonicalUrl: "".concat(window.location.origin, "/for-real-estate-agents"),
        schema
      }
    ),
...
export {
  ForRealEstateAgents as default
};
