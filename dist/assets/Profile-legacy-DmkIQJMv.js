;
(function () {
  System.register(['./react-vendor-legacy-BZejsv6W.js', './useProfile-legacy-DrgEb0hd.js', './supabase-legacy-CQONYrP8.js', './state-stores-legacy-80VekGrm.js', './index-legacy-CvrXsObU.js', './ui-components-legacy-oJhN_-ge.js', './icons-legacy-C8x4ypXf.js', './charts-legacy-D2SqRQVB.js', './utils-legacy-B2316hnE.js', './data-legacy-BmYdDdMQ.js', './three-addons-legacy-COT_Kqtz.js', './three-legacy-VFAp7wzH.js', './forms-legacy-BImVIBp0.js'], function (exports, module) {
    'use strict';

    var reactExports, jsxRuntimeExports, useProfile, supabase, useAuthStore, useToast, Tabs, TabsList, TabsTrigger, TabsContent, Save, Camera, Plus, X;
    return {
      setters: [module => {
        ...
        function Profile() {
          ...
          const addCity = () => {
            if (cityInput.trim() && !formData.service_cities.includes(cityInput.trim())) {
              setFormData({
                ...formData,
                service_cities: [...formData.service_cities, cityInput.trim()]
              });
              setCityInput("");
            }
          };
            ...
            children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
              ...
              children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                children: [/* @__PURE__ */jsxRuntimeExports.jsx("h1", {
                  ...
                  children: "Update your agent information and contact details"
                })]
              ...
              children: [/* @__PURE__ */jsxRuntimeExports.jsx("h2", {
                ...
                children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                  className: "relative",
                  children: [formData.avatar_url ? /* @__PURE__ */jsxRuntimeExports.jsx("img", {
                    ...
                    children: formData.full_name?.split(" ").map(n => n[0]).join("") || formData.username?.[0]?.toUpperCase() || "?"
                    ...
                    children: /* @__PURE__ */jsxRuntimeExports.jsx(Camera, {
                      className: "h-4 w-4"
                    })
                  })]
                }), /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx("h3", {
                    ...
                    children: "JPG, PNG or WEBP. Max size 5MB."
                  }), /* @__PURE__ */jsxRuntimeExports.jsx("button", {
                    type: "button",
                    onClick: () => fileInputRef.current?.click(),
                    disabled: uploading,
              ...
              children: [/* @__PURE__ */jsxRuntimeExports.jsxs(TabsList, {
                ...
                children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx("h2", {
                    ...
                    children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                      ...
                      children: [/* @__PURE__ */jsxRuntimeExports.jsx("label", {
                        ...
                        children: ["Your profile URL: agentbio.net/", formData.username]
                      })]
                    }), /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx("h2", {
                    ...
                    children: [formData.bio.length, "/500 characters"]
                  })]
                })]
              }), /* @__PURE__ */jsxRuntimeExports.jsxs(TabsContent, {
                value: "professional",
                ...
                children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx("h2", {
                    ...
                    children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                      ...
                      children: formData.specialties.map((specialty, index) => /* @__PURE__ */jsxRuntimeExports.jsxs("span", {
                        className: "inline-flex items-center gap-2 px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-sm",
                        children: [specialty, /* @__PURE__ */jsxRuntimeExports.jsx("button", {
                          type: "button",
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx("h2", {
                    ...
                    children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                      ...
                      className: "flex flex-wrap gap-2",
                      children: formData.certifications.map((cert, index) => /* @__PURE__ */jsxRuntimeExports.jsxs("span", {
                        className: "inline-flex items-center gap-2 px-3 py-1 bg-green-100 text-green-800 rounded-full text-sm",
                        children: [cert, /* @__PURE__ */jsxRuntimeExports.jsx("button", {
                          type: "button",
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx("h2", {
                    ...
                    children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                      ...
                      children: [/* @__PURE__ */jsxRuntimeExports.jsx("label", {
                        ...
                        className: "text-xs text-muted-foreground mt-1",
                        children: "Optional - shown on your public profile"
                      })]
                    }), /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                      className: "md:col-span-2",
                      children: [/* @__PURE__ */jsxRuntimeExports.jsx("label", {
                      ...
                      children: [/* @__PURE__ */jsxRuntimeExports.jsx("label", {
                        ...
                        className: "text-xs text-muted-foreground mt-1",
                        children: 'Add your Calendly link to enable "Book a Showing" on your listings'
                      })]
                    })]
                  })]
                })
                ...
                children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx("h2", {
                    ...
                    children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                      ...
                      className: "flex flex-wrap gap-2",
                      children: formData.service_cities.map((city, index) => /* @__PURE__ */jsxRuntimeExports.jsxs("span", {
                        className: "inline-flex items-center gap-2 px-3 py-1 bg-purple-100 text-purple-800 rounded-full text-sm",
                        children: [city, /* @__PURE__ */jsxRuntimeExports.jsx("button", {
                          type: "button",
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx("h2", {
                    ...
                    children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                      ...
                      className: "flex flex-wrap gap-2",
                      children: formData.service_zip_codes.map((zip, index) => /* @__PURE__ */jsxRuntimeExports.jsxs("span", {
                        className: "inline-flex items-center gap-2 px-3 py-1 bg-orange-100 text-orange-800 rounded-full text-sm",
                        children: [zip, /* @__PURE__ */jsxRuntimeExports.jsx("button", {
                          type: "button",
                ...
                children: /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx("h2", {
                    ...
                    children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                      ...
                      children: [/* @__PURE__ */jsxRuntimeExports.jsx("label", {
                        className: "block text-sm font-medium text-foreground mb-2",
                        children: "Realtor.com Profile URL"
                      }), /* @__PURE__ */jsxRuntimeExports.jsx("input", {
                        type: "url",
                ...
                children: /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx("h2", {
                    ...
                    children: "Optimize how your profile appears in search engines like Google"
                  }), /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                    className: "space-y-6",
                    children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                      children: [/* @__PURE__ */jsxRuntimeExports.jsx("label", {
                        ...
                        children: [/* @__PURE__ */jsxRuntimeExports.jsx("p", {
                          ...
                          children: "The title that appears in Google search results"
                        }), /* @__PURE__ */jsxRuntimeExports.jsxs("span", {
                          className: `text-xs font-medium ${formData.seo_title.length > 60 ? "text-red-600" : "text-muted-foreground"}`,
                          children: [formData.seo_title.length, "/60"]
                        })]
                      })]
                    }), /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                      children: [/* @__PURE__ */jsxRuntimeExports.jsx("label", {
                        ...
                        children: [/* @__PURE__ */jsxRuntimeExports.jsx("p", {
                          className: "text-xs text-muted-foreground",
                          children: "The description that appears in Google search results"
                        }), /* @__PURE__ */jsxRuntimeExports.jsxs("span", {
                          className: `text-xs font-medium ${formData.seo_description.length > 160 ? "text-red-600" : "text-muted-foreground"}`,
                          children: [formData.seo_description.length, "/160"]
                        })]
                      })]
                    }), /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                      className: "mt-8",
                      children: [/* @__PURE__ */jsxRuntimeExports.jsx("h3", {
                        ...
                        children: /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                          ...
                          children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                            className: "text-xs text-muted-foreground",
                            children: [window.location.origin, "/", formData.username || "username"]
                          }), /* @__PURE__ */jsxRuntimeExports.jsx("div", {
                            className: "text-lg text-blue-600 hover:underline cursor-pointer font-medium line-clamp-1",
                            children: formData.seo_title || `${formData.full_name || "Your Name"} - Real Estate Agent`
                          }), /* @__PURE__ */jsxRuntimeExports.jsx("div", {
                            className: "text-sm text-muted-foreground line-clamp-2",
                            children: formData.seo_description || `Professional real estate services by ${formData.full_name || "Your Name"}. Contact me today for all your real estate needs.`
                          })]
                        })
                      })]
                    }), /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                      className: "bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-900 rounded-lg p-4 mt-6",
                      children: [/* @__PURE__ */jsxRuntimeExports.jsx("h4", {
                        className: "font-semibold text-sm mb-3 text-blue-900 dark:text-blue-100",
                        children: "💡 SEO Best Practices"
                      }), /* @__PURE__ */jsxRuntimeExports.jsxs("ul", {
                        className: "text-sm text-blue-800 dark:text-blue-200 space-y-2",
