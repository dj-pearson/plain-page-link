;
(function () {
  System.register(['./react-vendor-legacy-BZejsv6W.js', './state-stores-legacy-80VekGrm.js', './ui-components-legacy-oJhN_-ge.js', './data-legacy-BmYdDdMQ.js', './supabase-legacy-CQONYrP8.js', './utils-legacy-B2316hnE.js', './icons-legacy-C8x4ypXf.js', './SEOManager-legacy-DkYqGUcp.js', './SearchAnalyticsDashboard-legacy-D-8Hg7WY.js', './charts-legacy-D2SqRQVB.js', './index-legacy-CvrXsObU.js', './three-addons-legacy-COT_Kqtz.js', './three-legacy-VFAp7wzH.js', './forms-legacy-BImVIBp0.js'], function (exports, module) {
    'use strict';

    var reactExports, jsxRuntimeExports, Navigate, Link, useAuthStore, Dialog, DialogTrigger, Button, DialogContent, DialogHeader, DialogTitle, DialogDescription, Label, Input, Select, SelectTrigger, SelectValue, SelectContent, SelectItem, Switch, DialogFooter, Card, CardHeader, CardTitle, CardDescription, CardContent, Badge, Textarea, Tabs, TabsList, TabsTrigger, TabsContent, useQueryClient, useQuery, useMutation, supabase, ue, format, Plus, LoaderCircle, Brain, TestTube, Sparkles, Calendar, Send, Eye, SquarePen, Trash, Link2, ToggleRight, ToggleLeft, Upload, Download, Lightbulb, Hash, Zap, Clock, CircleX, CircleCheckBig, TrendingUp, ExternalLink, Settings, ArrowLeft, BrainCircuit, Share2, FileText, Database, Search, BarChart3, Users, SEOManager, SearchAnalyticsDashboard;
    return {
      setters: [module => {
        ...
        SearchAnalyticsDashboard = module.S;
        ...
        function useAIConfiguration() {
          ...
          const modelsQuery = useQuery({
            ...
            queryFn: async () => {
              const {
                data,
                error
              } = await supabase.from("ai_models").select("*").order("provider", {
                ascending: true
              });
          ...
          const configQuery = useQuery({
            ...
            queryFn: async () => {
              const {
                data,
                error
              } = await supabase.from("ai_configuration").select("*");
              if (error) throw error;
              return data;
            }
          });
          const updateConfigMutation = useMutation({
            mutationFn: async ({
              ...
              const {
                error
              } = await supabase.from("ai_configuration").update({
                setting_value: value,
          ...
          const addModelMutation = useMutation({
            mutationFn: async model => {
              const {
                error
              } = await supabase.from("ai_models").insert([model]);
              if (error) throw error;
            },
            onSuccess: () => {
              queryClient.invalidateQueries({
          ...
          const testModelMutation = useMutation({
            mutationFn: async model => {
              const {
                data,
                error
              } = await supabase.functions.invoke("test-ai-model", {
                body: {
                  model
                }
              });
              ...
              children: /* @__PURE__ */jsxRuntimeExports.jsxs("form", {
                ...
                children: [/* @__PURE__ */jsxRuntimeExports.jsxs(DialogHeader, {
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx(DialogTitle, {
                    children: "Add New AI Model"
                  }), /* @__PURE__ */jsxRuntimeExports.jsx(DialogDescription, {
                    children: "Configure a new AI model with authentication and endpoint details"
                  })]
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                    ...
                    children: [/* @__PURE__ */jsxRuntimeExports.jsx(Label, {
                      ...
                      children: "The exact model identifier for API calls"
                    })]
                  }), /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                    className: "space-y-2",
                    children: [/* @__PURE__ */jsxRuntimeExports.jsx(Label, {
                    ...
                    children: [/* @__PURE__ */jsxRuntimeExports.jsx(Label, {
                      ...
                      children: [/* @__PURE__ */jsxRuntimeExports.jsx(SelectTrigger, {
                        ...
                        children: [/* @__PURE__ */jsxRuntimeExports.jsx(SelectItem, {
                          ...
                          value: "x-api-key",
                          children: "X-API-Key Header"
                        })]
                      })]
                    }), /* @__PURE__ */jsxRuntimeExports.jsx("p", {
                      className: "text-xs text-muted-foreground",
                      children: "How the API key is sent (Bearer for most, X-API-Key for Anthropic)"
                    })]
                  }), /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                    className: "space-y-2",
                    children: [/* @__PURE__ */jsxRuntimeExports.jsx(Label, {
                      htmlFor: "secret_name",
                      children: "Supabase Secret Name *"
                    }), /* @__PURE__ */jsxRuntimeExports.jsx(Input, {
                      id: "secret_name",
                      ...
                      className: "text-xs text-muted-foreground",
                      children: "Name of the secret stored in Supabase (must be added to Supabase secrets)"
                    })]
                  }), /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                    className: "space-y-2",
                    children: [/* @__PURE__ */jsxRuntimeExports.jsx(Label, {
                    ...
                    children: [/* @__PURE__ */jsxRuntimeExports.jsx(Label, {
                      htmlFor: "supports_vision",
                      children: "Supports Vision"
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx(Button, {
                    ...
                    type: "submit",
                    disabled: isAdding,
                    children: [isAdding && /* @__PURE__ */jsxRuntimeExports.jsx(LoaderCircle, {
            ...
            children: [/* @__PURE__ */jsxRuntimeExports.jsxs(Card, {
              children: [/* @__PURE__ */jsxRuntimeExports.jsxs(CardHeader, {
                children: [/* @__PURE__ */jsxRuntimeExports.jsxs(CardTitle, {
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx(Brain, {
                    className: "h-5 w-5"
                  }), "AI Model Configuration"]
                }), /* @__PURE__ */jsxRuntimeExports.jsx(CardDescription, {
                  children: "Configure AI models and settings for content generation"
                })]
                ...
                children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx(Label, {
                    ...
                    children: [/* @__PURE__ */jsxRuntimeExports.jsxs(Select, {
                      ...
                      children: [/* @__PURE__ */jsxRuntimeExports.jsx(SelectTrigger, {
                        ...
                        children: models?.map(model => /* @__PURE__ */jsxRuntimeExports.jsxs(SelectItem, {
                          value: model.model_id,
                          children: [model.model_name, " (", model.provider, ")"]
                        }, model.id))
                      })]
                      ...
                      title: "Test AI Model",
                      children: isTestingModel ? /* @__PURE__ */jsxRuntimeExports.jsx(LoaderCircle, {
                        className: "h-4 w-4 animate-spin"
                      }) : /* @__PURE__ */jsxRuntimeExports.jsx(TestTube, {
                        className: "h-4 w-4"
                      })
                    })]
                  })]
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                    className: "space-y-2",
                    children: [/* @__PURE__ */jsxRuntimeExports.jsx(Label, {
                      htmlFor: "temp-precise",
                      children: "Precise Temperature"
                    }), /* @__PURE__ */jsxRuntimeExports.jsx(Input, {
                      id: "temp-precise",
                      type: "number",
                      step: "0.1",
                      ...
                      className: "text-xs text-muted-foreground",
                      children: "For data extraction and precise tasks"
                    })]
                  }), /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                    className: "space-y-2",
                    children: [/* @__PURE__ */jsxRuntimeExports.jsx(Label, {
                      htmlFor: "temp-creative",
                      children: "Creative Temperature"
                    }), /* @__PURE__ */jsxRuntimeExports.jsx(Input, {
                      id: "temp-creative",
                      type: "number",
                      step: "0.1",
                      ...
                      className: "text-xs text-muted-foreground",
                      children: "For content generation and creative tasks"
                    })]
                  })]
                }), /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                  className: "grid grid-cols-1 md:grid-cols-2 gap-4",
                  children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                    className: "space-y-2",
                    children: [/* @__PURE__ */jsxRuntimeExports.jsx(Label, {
                      htmlFor: "tokens-standard",
                      children: "Standard Max Tokens"
                    }), /* @__PURE__ */jsxRuntimeExports.jsx(Input, {
                      id: "tokens-standard",
                      type: "number",
                      step: "100",
                    ...
                    className: "space-y-2",
                    children: [/* @__PURE__ */jsxRuntimeExports.jsx(Label, {
                      htmlFor: "tokens-large",
                      children: "Large Content Max Tokens"
                    }), /* @__PURE__ */jsxRuntimeExports.jsx(Input, {
                      id: "tokens-large",
                      type: "number",
                      step: "100",
              ...
              children: [/* @__PURE__ */jsxRuntimeExports.jsx(CardHeader, {
                children: /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                    children: [/* @__PURE__ */jsxRuntimeExports.jsx(CardTitle, {
                      children: "Available AI Models"
                    }), /* @__PURE__ */jsxRuntimeExports.jsx(CardDescription, {
                      children: "Manage which models are available for selection"
                    })]
                  }), /* @__PURE__ */jsxRuntimeExports.jsx(AddModelDialog, {
                    onAdd: addModel,
                ...
                children: /* @__PURE__ */jsxRuntimeExports.jsx("div", {
                  className: "space-y-4",
                  children: models?.map(model => /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                    ...
                    children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                      ...
                      children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                        ...
                        children: [/* @__PURE__ */jsxRuntimeExports.jsxs("span", {
                          children: ["Context: ", model.context_window.toLocaleString(), " tokens"]
                        }), /* @__PURE__ */jsxRuntimeExports.jsxs("span", {
                          children: ["Max Output: ", model.max_output_tokens.toLocaleString(), " tokens"]
                        }), model.supports_vision && /* @__PURE__ */jsxRuntimeExports.jsx("span", {
                          children: "✓ Vision"
                        })]
                      }), /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                        ...
                        children: [/* @__PURE__ */jsxRuntimeExports.jsx(Badge, {
                          variant: "secondary",
                          children: model.auth_type === "bearer" ? "Bearer Token" : "X-API-Key"
                        }), /* @__PURE__ */jsxRuntimeExports.jsxs(Badge, {
                          variant: "secondary",
                          children: ["Secret: ", model.secret_name]
                        })]
                      }), /* @__PURE__ */jsxRuntimeExports.jsx("p", {
                        className: "text-xs text-muted-foreground mt-2 font-mono truncate",
                        children: model.api_endpoint
                      })]
                    }), /* @__PURE__ */jsxRuntimeExports.jsx(Switch, {
        ...
        function useSocialMedia() {
          ...
          const postsQuery = useQuery({
            ...
            queryFn: async () => {
              const {
                data,
                error
              } = await supabase.from("social_media_posts").select("*").order("created_at", {
                ascending: false
              });
              if (error) throw error;
              return data;
          ...
          const marketingPostsQuery = useQuery({
            ...
            queryFn: async () => {
              const {
                data,
                error
              } = await supabase.from("social_media_posts").select("*").eq("content_type", "marketing").order("created_at", {
                ascending: false
              });
              if (error) throw error;
              return data;
          ...
          const webhooksQuery = useQuery({
            ...
            queryFn: async () => {
              const {
                data,
                error
              } = await supabase.from("social_media_webhooks").select("*").order("name", {
                ascending: true
              });
              if (error) throw error;
              return data;
          ...
          const generatePostMutation = useMutation({
            mutationFn: async params => {
              const {
                data,
                error
              } = await supabase.functions.invoke("generate-social-post", {
                body: params
              });
              if (error) throw error;
              return data;
          ...
          const updatePostMutation = useMutation({
            mutationFn: async ({
              ...
              const {
                error
              } = await supabase.from("social_media_posts").update(updates).eq("id", id);
              if (error) throw error;
            },
            onSuccess: () => {
              queryClient.invalidateQueries({
          ...
          const createWebhookMutation = useMutation({
            mutationFn: async webhook => {
              const {
                data,
                error
              } = await supabase.from("social_media_webhooks").insert(webhook).select().single();
              if (error) throw error;
              return data;
            },
            onSuccess: () => {
          ...
          const updateWebhookMutation = useMutation({
            mutationFn: async ({
              ...
              const {
                error
              } = await supabase.from("social_media_webhooks").update(updates).eq("id", id);
              if (error) throw error;
            },
            onSuccess: () => {
              queryClient.invalidateQueries({
          ...
          const deleteWebhookMutation = useMutation({
            mutationFn: async id => {
              const {
                error
              } = await supabase.from("social_media_webhooks").delete().eq("id", id);
              if (error) throw error;
            },
            onSuccess: () => {
              queryClient.invalidateQueries({
          ...
          const testWebhookMutation = useMutation({
            mutationFn: async webhookId => {
              const {
                data,
                error
              } = await supabase.functions.invoke("test-social-webhook", {
                body: {
                  webhookId
                }
              });
          ...
          const generateMarketingPostMutation = useMutation({
            mutationFn: async webhookUrl => {
              const {
                data,
                error
              } = await supabase.functions.invoke("generate-marketing-post", {
                body: {
                  webhookUrl
                }
              });
          ...
          const retryMarketingPostMutation = useMutation({
            mutationFn: async ({
              ...
              const {
                data: post
              } = await supabase.from("social_media_posts").select("post_content").eq("id", postId).single();
          ...
          const {
            ...
            queryFn: async () => {
              const {
                data,
                error
              } = await supabase.from("listings").select("id, address, price, status").eq("status", "active").order("created_at", {
                ascending: false
              }).limit(20);
              if (error) throw error;
              return data;
            ...
            children: [/* @__PURE__ */jsxRuntimeExports.jsx(DialogTrigger, {
              ...
              children: [/* @__PURE__ */jsxRuntimeExports.jsxs(DialogHeader, {
                children: [/* @__PURE__ */jsxRuntimeExports.jsx(DialogTitle, {
                  ...
                  children: "Generate AI-powered social media content for your real estate business"
                })]
              }), /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                ...
                children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx(Label, {
                    ...
                    children: [/* @__PURE__ */jsxRuntimeExports.jsx(SelectTrigger, {
                      ...
                      children: [/* @__PURE__ */jsxRuntimeExports.jsx(SelectItem, {
                        value: "property_highlight",
                        children: "Property Highlight"
                      }), /* @__PURE__ */jsxRuntimeExports.jsx(SelectItem, {
                        value: "market_update",
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx(Label, {
                    ...
                    children: [/* @__PURE__ */jsxRuntimeExports.jsx(SelectTrigger, {
                      ...
                      children: [/* @__PURE__ */jsxRuntimeExports.jsx(SelectItem, {
                        value: "listing_of_the_day",
                        children: "Listing of the Day"
                      }), /* @__PURE__ */jsxRuntimeExports.jsx(SelectItem, {
                        value: "market_analysis",
                        children: "Market Analysis"
                      }), /* @__PURE__ */jsxRuntimeExports.jsx(SelectItem, {
                        value: "buyer_seller_tip",
                        children: "Buyer/Seller Tip"
                      }), /* @__PURE__ */jsxRuntimeExports.jsx(SelectItem, {
                        value: "neighborhood_feature",
                        children: "Neighborhood Feature"
                      }), /* @__PURE__ */jsxRuntimeExports.jsx(SelectItem, {
                        value: "testimonial_highlight",
                        children: "Testimonial Highlight"
                      }), /* @__PURE__ */jsxRuntimeExports.jsx(SelectItem, {
                        value: "special_announcement",
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx(Label, {
                    ...
                    children: [/* @__PURE__ */jsxRuntimeExports.jsx(SelectTrigger, {
                      ...
                      children: [/* @__PURE__ */jsxRuntimeExports.jsx(SelectItem, {
                        ...
                        value: "twitter_threads",
                        children: "Twitter/X Threads"
                      }), /* @__PURE__ */jsxRuntimeExports.jsx(SelectItem, {
                        value: "facebook_linkedin",
                        children: "Facebook/LinkedIn"
                      }), /* @__PURE__ */jsxRuntimeExports.jsx(SelectItem, {
                        value: "instagram",
                        children: "Instagram"
                      })]
                ...
                }), contentType === "property_highlight" && listings && listings.length > 0 && /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                  className: "space-y-2",
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx(Label, {
                    htmlFor: "listing",
                    children: "Select Property (Optional)"
                  }), /* @__PURE__ */jsxRuntimeExports.jsxs(Select, {
                    value: listingId,
                    ...
                    children: [/* @__PURE__ */jsxRuntimeExports.jsx(SelectTrigger, {
                      ...
                      children: listings.map(listing => /* @__PURE__ */jsxRuntimeExports.jsxs(SelectItem, {
                        value: listing.id,
                        children: [listing.address, " - ", listing.price]
                      }, listing.id))
                    })]
                  })]
                }), /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                ...
                }), generatedContent && /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                    ...
                    children: [/* @__PURE__ */jsxRuntimeExports.jsx(Label, {
                      ...
                      className: "p-4 bg-background border rounded-lg whitespace-pre-wrap text-sm",
                      children: generatedContent[platformType] || generatedContent.raw
                    })]
                  }), /* @__PURE__ */jsxRuntimeExports.jsx(Button, {
                    onClick: handleSave,
                    className: "w-full",
        ...
        function SocialMediaWebhookDialog() {
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs(Dialog, {
            ...
            children: [/* @__PURE__ */jsxRuntimeExports.jsx(DialogTrigger, {
              ...
              children: [/* @__PURE__ */jsxRuntimeExports.jsxs(DialogHeader, {
                children: [/* @__PURE__ */jsxRuntimeExports.jsx(DialogTitle, {
                  children: "Add Social Media Webhook"
                }), /* @__PURE__ */jsxRuntimeExports.jsx(DialogDescription, {
                  children: "Configure a webhook to automatically distribute posts to your platforms"
                })]
        ...
        function SocialMediaManager() {
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
            ...
            children: [/* @__PURE__ */jsxRuntimeExports.jsxs(Card, {
              children: [/* @__PURE__ */jsxRuntimeExports.jsx(CardHeader, {
                children: /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                    children: [/* @__PURE__ */jsxRuntimeExports.jsx(CardTitle, {
                      ...
                      children: "Manage and generate social media posts for your real estate business"
                    })]
                ...
                children: /* @__PURE__ */jsxRuntimeExports.jsxs(Tabs, {
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsxs(TabsList, {
                    ...
                    children: filteredPosts && filteredPosts.length > 0 ? filteredPosts.map(post => /* @__PURE__ */jsxRuntimeExports.jsx("div", {
                      ...
                      children: /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                        ...
                        children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                          ...
                          children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                            ...
                            className: "flex flex-wrap gap-2 text-sm text-muted-foreground mb-3",
                            children: [/* @__PURE__ */jsxRuntimeExports.jsx("span", {
                              className: "inline-flex items-center gap-1",
                              children: /* @__PURE__ */jsxRuntimeExports.jsx(Badge, {
                                variant: "outline",
                                children: getContentTypeLabel(post.content_type)
                              })
                            }), /* @__PURE__ */jsxRuntimeExports.jsx("span", {
                              className: "inline-flex items-center gap-1",
                              children: /* @__PURE__ */jsxRuntimeExports.jsx(Badge, {
                                variant: "outline",
                                children: getContentTypeLabel(post.subject_type)
                              })
                            }), /* @__PURE__ */jsxRuntimeExports.jsx("span", {
                              className: "inline-flex items-center gap-1",
                              children: /* @__PURE__ */jsxRuntimeExports.jsx(Badge, {
                                variant: "outline",
                                children: getContentTypeLabel(post.platform_type)
                              })
                            })]
                          }), /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                            className: "flex items-center gap-4 text-xs text-muted-foreground",
                            children: [/* @__PURE__ */jsxRuntimeExports.jsxs("span", {
                              children: ["Created: ", format(new Date(post.created_at), "MMM d, yyyy h:mm a")]
                            }), post.scheduled_for && /* @__PURE__ */jsxRuntimeExports.jsxs("span", {
                              className: "flex items-center gap-1",
                              children: [/* @__PURE__ */jsxRuntimeExports.jsx(Calendar, {
                                className: "h-3 w-3"
                              }), "Scheduled: ", format(new Date(post.scheduled_for), "MMM d, yyyy h:mm a")]
                            }), post.posted_at && /* @__PURE__ */jsxRuntimeExports.jsxs("span", {
                              className: "flex items-center gap-1",
                    ...
                    }, post.id)) : /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                ...
                children: /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                    children: [/* @__PURE__ */jsxRuntimeExports.jsx(CardTitle, {
                      ...
                      children: "Configure webhooks for automatic post distribution"
                    })]
                  }), /* @__PURE__ */jsxRuntimeExports.jsx(SocialMediaWebhookDialog, {})]
                })
              }), /* @__PURE__ */jsxRuntimeExports.jsx(CardContent, {
                children: webhooks && webhooks.length > 0 ? /* @__PURE__ */jsxRuntimeExports.jsx("div", {
                  className: "space-y-3",
                  children: webhooks.map(webhook => /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                    className: "flex items-center justify-between p-4 border rounded-lg",
                    children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                      className: "flex items-center gap-3",
                      children: [/* @__PURE__ */jsxRuntimeExports.jsx(Link2, {
                      ...
                      children: [/* @__PURE__ */jsxRuntimeExports.jsx(Button, {
                        ...
                        children: isTestingWebhook ? /* @__PURE__ */jsxRuntimeExports.jsx(LoaderCircle, {
                          className: "h-4 w-4 animate-spin"
                        ...
                        children: webhook.is_active ? /* @__PURE__ */jsxRuntimeExports.jsx(ToggleRight, {
                          className: "h-5 w-5 text-green-600"
                        }) : /* @__PURE__ */jsxRuntimeExports.jsx(ToggleLeft, {
                  ...
                  children: /* @__PURE__ */jsxRuntimeExports.jsx("p", {
                    ...
                    children: "No webhooks configured yet. Add a webhook to automatically distribute posts."
                  })
                })
              })]
            }), /* @__PURE__ */jsxRuntimeExports.jsxs(Card, {
              children: [/* @__PURE__ */jsxRuntimeExports.jsxs(CardHeader, {
                children: [/* @__PURE__ */jsxRuntimeExports.jsx(CardTitle, {
                  children: "Marketing Post Generator"
                }), /* @__PURE__ */jsxRuntimeExports.jsx(CardDescription, {
                  children: "Generate unique, catchy social media posts to drive agent signups"
                })]
              }), /* @__PURE__ */jsxRuntimeExports.jsxs(CardContent, {
                className: "space-y-4",
                children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx(Button, {
                    ...
                    className: "flex-1",
                    children: isGeneratingMarketingPost ? /* @__PURE__ */jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
                      children: [/* @__PURE__ */jsxRuntimeExports.jsx(LoaderCircle, {
                  ...
                  }), webhooks && webhooks.length > 0 && /* @__PURE__ */jsxRuntimeExports.jsx(Button, {
                    variant: "outline",
                    onClick: () => {
                ...
                }), marketingPostData && marketingPostData.payload && /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                  className: "space-y-4 mt-4 border-t pt-4",
                  children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                    children: [/* @__PURE__ */jsxRuntimeExports.jsx("h4", {
                      className: "font-semibold mb-2",
                      children: "Long Form (LinkedIn/Facebook):"
                    }), /* @__PURE__ */jsxRuntimeExports.jsx("div", {
                      className: "bg-muted p-4 rounded-lg text-sm whitespace-pre-wrap",
                      children: marketingPostData.payload.longFormPost
                    })]
                  }), /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                    children: [/* @__PURE__ */jsxRuntimeExports.jsx("h4", {
                      className: "font-semibold mb-2",
                      children: "Short Form (Twitter/Threads):"
                    }), /* @__PURE__ */jsxRuntimeExports.jsx("div", {
                      className: "bg-muted p-4 rounded-lg text-sm",
                      children: marketingPostData.payload.shortFormPost
                    })]
                  }), /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                    children: [/* @__PURE__ */jsxRuntimeExports.jsx("h4", {
                      className: "font-semibold mb-2",
                      ...
                      children: marketingPostData.payload.hashtags.map((tag, idx) => /* @__PURE__ */jsxRuntimeExports.jsx(Badge, {
                        variant: "secondary",
                        children: tag
                      }, idx))
                    })]
              ...
              children: [/* @__PURE__ */jsxRuntimeExports.jsxs(CardHeader, {
                children: [/* @__PURE__ */jsxRuntimeExports.jsx(CardTitle, {
                  children: "Marketing Post History"
                }), /* @__PURE__ */jsxRuntimeExports.jsx(CardDescription, {
                  children: "View and redeploy previously generated marketing posts"
                })]
              }), /* @__PURE__ */jsxRuntimeExports.jsx(CardContent, {
                children: marketingPosts && marketingPosts.length > 0 ? /* @__PURE__ */jsxRuntimeExports.jsx("div", {
                  className: "space-y-4",
                  children: marketingPosts.map(post => {
                      ...
                      children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                        ...
                        children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                          ...
                          children: [/* @__PURE__ */jsxRuntimeExports.jsx(Badge, {
                            ...
                            className: "text-sm text-muted-foreground",
                            children: format(new Date(post.created_at), "MMM d, yyyy h:mm a")
                          })]
                        }), /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                          className: "flex gap-2",
                          children: [webhooks && webhooks.length > 0 && /* @__PURE__ */jsxRuntimeExports.jsx(Button, {
                            variant: "outline",
                            size: "sm",
                            onClick: () => {
                              const activeWebhook = webhooks.find(w => w.is_active);
                            ...
                            children: isRetryingPost ? /* @__PURE__ */jsxRuntimeExports.jsx(LoaderCircle, {
                              className: "h-4 w-4 animate-spin"
                            }) : /* @__PURE__ */jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
                              children: [/* @__PURE__ */jsxRuntimeExports.jsx(Send, {
                                className: "h-4 w-4 mr-2"
                        ...
                        children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                          ...
                          children: [/* @__PURE__ */jsxRuntimeExports.jsx("h4", {
                            ...
                            children: content.shortFormPost
                          })]
                        }), /* @__PURE__ */jsxRuntimeExports.jsx("div", {
                          className: "flex flex-wrap gap-1",
                          children: content.hashtags?.map((tag, idx) => /* @__PURE__ */jsxRuntimeExports.jsx(Badge, {
                            variant: "secondary",
                            className: "text-xs",
                            children: tag
                          }, idx))
                  ...
                  children: /* @__PURE__ */jsxRuntimeExports.jsx("p", {
                    className: "text-sm text-muted-foreground",
                    children: "No marketing posts generated yet. Create your first one above!"
                  })
                })
              })]
            })]
          ...
          const republishArticleMutation = useMutation({
            mutationFn: async id => {
              const {
                data,
                error
              } = await supabase.functions.invoke("publish-article-to-social", {
                body: {
                  articleId: id
                }
              });
        ...
        function useKeywords() {
          ...
          const {
            ...
            queryFn: async () => {
              const {
                data,
                error
              } = await supabase.from("keywords").select("*").order("usage_count", {
                ascending: true
              }).order("keyword", {
                ascending: true
              });
          ...
          const {
            ...
            queryFn: async () => {
              const {
                data,
                error
              } = await supabase.from("keywords").select("*").eq("is_active", true).order("usage_count", {
                ascending: true
              }).order("last_used_at", {
                ascending: true,
                nullsFirst: true
          ...
          const importKeywordsMutation = useMutation({
            mutationFn: async keywords2 => {
              ...
              const response = await fetch(`${supabase.supabaseUrl}/functions/v1/import-keywords`, {
                method: "POST",
                headers: {
          ...
          const updateKeywordMutation = useMutation({
            mutationFn: async ({
              ...
              const {
                data,
                error
              } = await supabase.from("keywords").update(updates).eq("id", id).select().single();
              if (error) throw error;
              return data;
            },
            onSuccess: () => {
          ...
          return {
            ...
            updateKeyword: (id, updates) => updateKeywordMutation.mutate({
              id,
              updates
            }),
        ...
        function useArticleWebhooks() {
          ...
          const webhooksQuery = useQuery({
            ...
            queryFn: async () => {
              const {
                data,
                error
              } = await supabase.from("article_webhooks").select("*").order("created_at", {
                ascending: false
              });
              if (error) throw error;
              return data;
          ...
          const createWebhookMutation = useMutation({
            mutationFn: async webhook => {
              ...
              const {
                data,
                error
              } = await supabase.from("article_webhooks").insert({
                ...webhook,
          ...
          const updateWebhookMutation = useMutation({
            mutationFn: async ({
              ...
              const {
                error
              } = await supabase.from("article_webhooks").update(updates).eq("id", id);
              if (error) throw error;
            },
            onSuccess: () => {
              queryClient.invalidateQueries({
          ...
          const deleteWebhookMutation = useMutation({
            mutationFn: async id => {
              const {
                error
              } = await supabase.from("article_webhooks").delete().eq("id", id);
              if (error) throw error;
            },
            onSuccess: () => {
              queryClient.invalidateQueries({
          ...
          const testWebhookMutation = useMutation({
            mutationFn: async webhookUrl => {
              const {
                data,
                error
              } = await supabase.functions.invoke("test-article-webhook", {
                body: {
                  webhookUrl
                }
              });
        ...
        function CreateArticleDialog() {
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs(Dialog, {
            ...
            children: [/* @__PURE__ */jsxRuntimeExports.jsx(DialogTrigger, {
              ...
              children: [/* @__PURE__ */jsxRuntimeExports.jsxs(DialogHeader, {
                children: [/* @__PURE__ */jsxRuntimeExports.jsx(DialogTitle, {
                  children: "Generate Blog Article"
                }), /* @__PURE__ */jsxRuntimeExports.jsx(DialogDescription, {
                  children: "Create SEO-optimized real estate articles with AI assistance"
                })]
              }), /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                className: "space-y-4 mt-4",
                children: [/* @__PURE__ */jsxRuntimeExports.jsxs(Tabs, {
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsxs(TabsList, {
                    ...
                    children: [/* @__PURE__ */jsxRuntimeExports.jsx(TabsTrigger, {
                      value: "keyword",
                      children: "From Keyword"
                    }), /* @__PURE__ */jsxRuntimeExports.jsx(TabsTrigger, {
                      value: "manual",
                      children: "Manual Topic"
                    })]
                  }), /* @__PURE__ */jsxRuntimeExports.jsx(TabsContent, {
                    value: "keyword",
                    className: "space-y-4",
                    children: /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                      ...
                      children: [/* @__PURE__ */jsxRuntimeExports.jsx(Label, {
                        ...
                        children: "Select Keyword (Optional - auto-selects if empty)"
                      }), /* @__PURE__ */jsxRuntimeExports.jsxs(Select, {
                        ...
                        children: [/* @__PURE__ */jsxRuntimeExports.jsx(SelectTrigger, {
                          id: "keyword-select",
                          children: /* @__PURE__ */jsxRuntimeExports.jsx(SelectValue, {
                            placeholder: "Auto-select unused keyword..."
                          })
                        }), /* @__PURE__ */jsxRuntimeExports.jsx(SelectContent, {
                          children: isLoadingKeywords ? /* @__PURE__ */jsxRuntimeExports.jsx(SelectItem, {
                            value: "loading",
                            disabled: true,
                            children: "Loading keywords..."
                          }) : unusedKeywords.length === 0 ? /* @__PURE__ */jsxRuntimeExports.jsx(SelectItem, {
                            value: "none",
                            disabled: true,
                            children: "No keywords available"
                          }) : unusedKeywords.map(kw => /* @__PURE__ */jsxRuntimeExports.jsxs(SelectItem, {
                            value: kw.id,
                            children: [kw.keyword, " (used ", kw.usage_count, " times)"]
                          }, kw.id))
                        })]
                      })]
                    })
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx(Label, {
                    ...
                    children: [/* @__PURE__ */jsxRuntimeExports.jsx(SelectTrigger, {
                      ...
                      children: [/* @__PURE__ */jsxRuntimeExports.jsx(SelectItem, {
                        value: "Real Estate Tips",
                        children: "Real Estate Tips"
                      }), /* @__PURE__ */jsxRuntimeExports.jsx(SelectItem, {
                        ...
                        value: "Selling Guide",
                        children: "Selling Guide"
                      }), /* @__PURE__ */jsxRuntimeExports.jsx(SelectItem, {
                        value: "Investment",
                        children: "Investment"
                      }), /* @__PURE__ */jsxRuntimeExports.jsx(SelectItem, {
                        value: "Neighborhood Guides",
                        children: "Neighborhood Guides"
                      }), /* @__PURE__ */jsxRuntimeExports.jsx(SelectItem, {
                ...
                }), generatedArticle && /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                  className: "space-y-4 p-4 border rounded-lg bg-muted/50",
                  children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                    children: [/* @__PURE__ */jsxRuntimeExports.jsx("h3", {
                      className: "font-bold text-lg mb-2",
                      children: generatedArticle.title
                    }), /* @__PURE__ */jsxRuntimeExports.jsxs("p", {
                      className: "text-sm text-muted-foreground mb-2",
                      children: ["Slug: ", generatedArticle.slug]
                    }), /* @__PURE__ */jsxRuntimeExports.jsx("p", {
                      className: "text-sm text-muted-foreground mb-4",
                      children: generatedArticle.excerpt
                    })]
                  }), /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                    className: "space-y-2",
                    children: [/* @__PURE__ */jsxRuntimeExports.jsx(Label, {
                      ...
                      className: "p-4 bg-background border rounded-lg max-h-96 overflow-y-auto",
                      children: /* @__PURE__ */jsxRuntimeExports.jsx("pre", {
                        className: "whitespace-pre-wrap text-sm font-mono",
                        children: generatedArticle.content
                      })
                    })]
                  }), /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                    ...
                    children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                      children: [/* @__PURE__ */jsxRuntimeExports.jsx("p", {
                        ...
                        className: "text-muted-foreground",
                        children: generatedArticle.seoTitle
                      })]
                    }), /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                      children: [/* @__PURE__ */jsxRuntimeExports.jsx("p", {
                        className: "font-semibold",
                        ...
                        className: "text-muted-foreground",
                        children: generatedArticle.seoDescription
                      })]
                    })]
                  }), /* @__PURE__ */jsxRuntimeExports.jsx(Button, {
                    onClick: handleSave,
        ...
        function ArticleWebhookDialog() {
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs(Dialog, {
            ...
            children: [/* @__PURE__ */jsxRuntimeExports.jsx(DialogTrigger, {
              ...
              children: [/* @__PURE__ */jsxRuntimeExports.jsxs(DialogHeader, {
                children: [/* @__PURE__ */jsxRuntimeExports.jsx(DialogTitle, {
                  children: "Add Article Webhook"
                }), /* @__PURE__ */jsxRuntimeExports.jsx(DialogDescription, {
                  children: "Configure a webhook to receive article data when articles are published"
                })]
              }), /* @__PURE__ */jsxRuntimeExports.jsxs("form", {
                onSubmit: handleSubmit,
                className: "space-y-4",
...
first time home buyer tips,Real Estate,easy,2000,Educational content`;
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs(Dialog, {
            ...
            children: [/* @__PURE__ */jsxRuntimeExports.jsx(DialogTrigger, {
              ...
              children: [/* @__PURE__ */jsxRuntimeExports.jsxs(DialogHeader, {
                children: [/* @__PURE__ */jsxRuntimeExports.jsx(DialogTitle, {
                  children: "Import Keywords from CSV"
                }), /* @__PURE__ */jsxRuntimeExports.jsx(DialogDescription, {
                  children: "Upload a CSV file with your keywords. New keywords will be added and existing ones will be skipped."
                })]
              }), /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                className: "space-y-4",
                children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx("input", {
                    ...
                    children: /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                      ...
                      children: [isImporting ? /* @__PURE__ */jsxRuntimeExports.jsx(LoaderCircle, {
                        className: "h-8 w-8 animate-spin text-primary"
                      }) : /* @__PURE__ */jsxRuntimeExports.jsx(Upload, {
                        className: "h-8 w-8 text-muted-foreground"
                      }), /* @__PURE__ */jsxRuntimeExports.jsx("p", {
                        className: "text-sm font-medium",
                        children: isImporting ? "Importing..." : "Click to upload CSV"
                      }), /* @__PURE__ */jsxRuntimeExports.jsx("p", {
                        className: "text-xs text-muted-foreground",
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx("p", {
                    ...
                    className: "bg-muted p-3 rounded-md text-xs font-mono",
                    children: "keyword,category,difficulty,search_volume,notes"
                  }), /* @__PURE__ */jsxRuntimeExports.jsxs("ul", {
                    className: "text-xs text-muted-foreground space-y-1 ml-4 list-disc",
        ...
        function useContentSuggestions() {
          ...
          const {
            ...
            queryFn: async () => {
              const {
                data,
                error
              } = await supabase.from("content_suggestions").select("*").order("priority", {
                ascending: false
              }).order("created_at", {
                ascending: false
              });
          ...
          const updateSuggestionMutation = useMutation({
            mutationFn: async ({
              ...
              const {
                data,
                error
              } = await supabase.from("content_suggestions").update(updates).eq("id", id).select().single();
              if (error) throw error;
              return data;
            },
            onSuccess: () => {
          ...
          const writeArticleMutation = useMutation({
            mutationFn: async suggestion => {
              ...
              await supabase.from("content_suggestions").update({
                status: "completed",
                generated_article_id: response.data?.article?.id
              }).eq("id", suggestion.id);
              return response.data;
            },
            onSuccess: () => {
          ...
          return {
            suggestions,
            isLoading,
            generateSuggestions: (customInstructions, count) => generateSuggestionsMutation.mutate({
              customInstructions,
              count
            }),
            isGenerating: generateSuggestionsMutation.isPending,
            updateSuggestion: (id, updates) => updateSuggestionMutation.mutate({
              id,
              updates
            }),
            deleteSuggestion: id => deleteSuggestionMutation.mutate(id),
            queueSuggestion: id => updateSuggestionMutation.mutate({
              id,
              updates: {
                status: "queued"
              }
            }),
            rejectSuggestion: id => updateSuggestionMutation.mutate({
              id,
              updates: {
                status: "rejected"
              }
        ...
        function ContentSuggestionsCard() {
          ...
          const getPriorityIcon = priority => {
            const p = priority || 3;
            if (p >= 4) return /* @__PURE__ */jsxRuntimeExports.jsx(TrendingUp, {
              className: "h-3 w-3 text-red-500"
            });
            if (p >= 3) return /* @__PURE__ */jsxRuntimeExports.jsx(TrendingUp, {
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs(Card, {
            children: [/* @__PURE__ */jsxRuntimeExports.jsx(CardHeader, {
              children: /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                ...
                children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                  children: [/* @__PURE__ */jsxRuntimeExports.jsxs(CardTitle, {
                    ...
                    children: "Generate high-value article ideas based on SEO keywords and market trends"
                  })]
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx(DialogTrigger, {
                    ...
                    children: [/* @__PURE__ */jsxRuntimeExports.jsxs(DialogHeader, {
                      children: [/* @__PURE__ */jsxRuntimeExports.jsx(DialogTitle, {
                        children: "Generate Content Suggestions"
                      }), /* @__PURE__ */jsxRuntimeExports.jsx(DialogDescription, {
                        children: "AI will analyze your existing keywords and articles to suggest relevant topics"
                      })]
                    }), /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                      className: "space-y-4",
                      children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                        children: [/* @__PURE__ */jsxRuntimeExports.jsx("label", {
                          className: "text-sm font-medium",
                          children: "Number of Suggestions"
                        }), /* @__PURE__ */jsxRuntimeExports.jsx(Input, {
                          type: "number",
                          min: "1",
                          max: "50",
                      ...
                      children: [/* @__PURE__ */jsxRuntimeExports.jsx(Button, {
                        ...
                        onClick: handleGenerate,
                        disabled: isGenerating,
                        children: [isGenerating && /* @__PURE__ */jsxRuntimeExports.jsx(LoaderCircle, {
                          className: "h-4 w-4 mr-2 animate-spin"
                        }), "Generate"]
                      })]
                    })]
              ...
              children: isLoading ? /* @__PURE__ */jsxRuntimeExports.jsx("div", {
              ...
              }) : suggestions.length > 0 ? /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                className: "space-y-6",
                children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                    ...
                    children: [/* @__PURE__ */jsxRuntimeExports.jsx("p", {
                      ...
                      children: queuedSuggestions.length
                    })]
                  }), /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                    className: "border rounded-lg p-3",
                    children: [/* @__PURE__ */jsxRuntimeExports.jsx("p", {
                      ...
                      children: suggestions.filter(s => s.status === "completed").length
                    })]
                  })]
                }), /* @__PURE__ */jsxRuntimeExports.jsx("div", {
                  className: "space-y-3",
                  children: suggestions.map(suggestion => /* @__PURE__ */jsxRuntimeExports.jsx("div", {
                    className: "border rounded-lg p-4 hover:border-primary transition-colors",
                    children: /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                      ...
                      children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                        ...
                        children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                          ...
                          children: [getPriorityIcon(suggestion.priority), /* @__PURE__ */jsxRuntimeExports.jsx("h4", {
                            className: "font-semibold",
                            children: suggestion.topic
                          }), /* @__PURE__ */jsxRuntimeExports.jsx(Badge, {
                            className: `${getStatusColor(suggestion.status)} text-white text-xs`,
                            children: suggestion.status || "pending"
                          })]
                        }), /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                          className: "flex flex-wrap gap-2 mt-2",
                          children: [/* @__PURE__ */jsxRuntimeExports.jsx(Badge, {
                            variant: "outline",
                            children: suggestion.category || "General"
                          }), suggestion.keywords?.slice(0, 3).map((keyword, idx) => /* @__PURE__ */jsxRuntimeExports.jsxs(Badge, {
                            variant: "secondary",
                            className: "gap-1",
                        ...
                        children: [suggestion.status === "pending" && /* @__PURE__ */jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
                          children: [/* @__PURE__ */jsxRuntimeExports.jsx(Button, {
                            variant: "outline",
                            size: "sm",
                            ...
                            children: isWritingArticle ? /* @__PURE__ */jsxRuntimeExports.jsx(LoaderCircle, {
                              className: "h-4 w-4 animate-spin"
                        ...
                        }), suggestion.status === "completed" && /* @__PURE__ */jsxRuntimeExports.jsx(Button, {
                          variant: "outline",
                          size: "sm",
                          disabled: true,
                          title: "Completed",
                ...
                children: [/* @__PURE__ */jsxRuntimeExports.jsx(Lightbulb, {
                  ...
                  children: "No content suggestions yet. Generate AI-powered topic ideas to get started."
                }), /* @__PURE__ */jsxRuntimeExports.jsxs(Dialog, {
                  open: isDialogOpen,
                  onOpenChange: setIsDialogOpen,
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx(DialogTrigger, {
            ...
            children: [/* @__PURE__ */jsxRuntimeExports.jsxs(Card, {
              children: [/* @__PURE__ */jsxRuntimeExports.jsx(CardHeader, {
                children: /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                    children: [/* @__PURE__ */jsxRuntimeExports.jsx(CardTitle, {
                      ...
                      children: "Manage your real estate blog content and articles"
                    })]
                ...
                children: /* @__PURE__ */jsxRuntimeExports.jsxs(Tabs, {
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsxs(TabsList, {
                    ...
                    value: activeTab,
                    className: "space-y-4 mt-6",
                    children: filteredArticles && filteredArticles.length > 0 ? filteredArticles.map(article => /* @__PURE__ */jsxRuntimeExports.jsx("div", {
                      className: "border rounded-lg p-4 hover:border-primary transition-colors",
                      children: /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                        className: "flex items-start justify-between",
                        children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                          ...
                          children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                          ...
                          }), article.excerpt && /* @__PURE__ */jsxRuntimeExports.jsxs("p", {
                            className: "text-sm text-muted-foreground mb-3",
                            children: [article.excerpt.substring(0, 150), "..."]
                          }), /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                            className: "flex flex-wrap gap-2 mb-3",
                            children: [/* @__PURE__ */jsxRuntimeExports.jsx(Badge, {
                              variant: "outline",
                              children: article.category
                            }), article.keyword_id && /* @__PURE__ */jsxRuntimeExports.jsxs(Badge, {
                              variant: "secondary",
                              className: "gap-1",
                              children: [/* @__PURE__ */jsxRuntimeExports.jsx(Hash, {
                                className: "h-3 w-3"
                              }), keywords?.find(k => k.id === article.keyword_id)?.keyword || "Keyword"]
                            }), article.tags?.slice(0, 2).map((tag, idx) => /* @__PURE__ */jsxRuntimeExports.jsx(Badge, {
                              variant: "secondary",
                              children: tag
                            }, idx))]
                          }), /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                            ...
                            children: [/* @__PURE__ */jsxRuntimeExports.jsxs("span", {
                              ...
                              children: ["Created: ", format(new Date(article.created_at), "MMM d, yyyy")]
                            }), article.published_at && /* @__PURE__ */jsxRuntimeExports.jsxs("span", {
                              children: ["Published: ", format(new Date(article.published_at), "MMM d, yyyy")]
                            })]
                          })]
                        }), /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                          className: "flex gap-2",
                          children: [/* @__PURE__ */jsxRuntimeExports.jsx(Button, {
                          ...
                          }), article.status === "draft" && /* @__PURE__ */jsxRuntimeExports.jsx(Button, {
                            variant: "outline",
                            size: "sm",
                            onClick: () => {
                          ...
                          }), article.status === "published" && /* @__PURE__ */jsxRuntimeExports.jsx(Button, {
                            variant: "outline",
                            size: "sm",
                            onClick: () => {
                            ...
                            children: isRepublishing ? /* @__PURE__ */jsxRuntimeExports.jsx(LoaderCircle, {
                              className: "h-4 w-4 animate-spin"
                            }) : /* @__PURE__ */jsxRuntimeExports.jsx(Send, {
                              className: "h-4 w-4"
                            })
                    ...
                    }, article.id)) : /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                      className: "text-center py-12",
                      children: [/* @__PURE__ */jsxRuntimeExports.jsx("p", {
                        className: "text-muted-foreground",
                        ...
                        className: "mt-4",
                        children: /* @__PURE__ */jsxRuntimeExports.jsx(CreateArticleDialog, {})
                      })]
                    })
                  })]
                })
              ...
              children: [/* @__PURE__ */jsxRuntimeExports.jsx(CardHeader, {
                children: /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                    children: [/* @__PURE__ */jsxRuntimeExports.jsx(CardTitle, {
                      children: "Keyword Management"
                    }), /* @__PURE__ */jsxRuntimeExports.jsx(CardDescription, {
                      children: "Track SEO keyword usage across articles"
                    })]
                  }), /* @__PURE__ */jsxRuntimeExports.jsx(KeywordImportDialog, {})]
                })
              }), /* @__PURE__ */jsxRuntimeExports.jsx(CardContent, {
                children: isLoadingKeywords ? /* @__PURE__ */jsxRuntimeExports.jsx("div", {
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                    ...
                    children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                      ...
                      children: [/* @__PURE__ */jsxRuntimeExports.jsx("p", {
                        className: "text-sm text-muted-foreground",
                        children: "Total Keywords"
                      }), /* @__PURE__ */jsxRuntimeExports.jsx("p", {
                        className: "text-2xl font-bold",
                        children: keywords?.length || 0
                      })]
                    }), /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                      className: "border rounded-lg p-4",
                      children: [/* @__PURE__ */jsxRuntimeExports.jsx("p", {
                        ...
                        className: "text-2xl font-bold text-green-600",
                        children: keywords?.filter(k => k.usage_count === 0).length || 0
                      })]
                    }), /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                      className: "border rounded-lg p-4",
                      children: [/* @__PURE__ */jsxRuntimeExports.jsx("p", {
                        ...
                        className: "text-2xl font-bold text-blue-600",
                        children: Math.max(...(keywords?.map(k => k.usage_count) || [0]))
                      })]
                    })]
                  }), /* @__PURE__ */jsxRuntimeExports.jsx("p", {
                    className: "text-sm text-muted-foreground",
                    children: "Keywords are automatically tracked when articles are published. Import your keywords.csv to get started."
                  })]
                })
              })]
            }), /* @__PURE__ */jsxRuntimeExports.jsx(ContentSuggestionsCard, {}), /* @__PURE__ */jsxRuntimeExports.jsxs(Card, {
              children: [/* @__PURE__ */jsxRuntimeExports.jsx(CardHeader, {
                children: /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                  className: "flex items-center justify-between",
                  children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                    children: [/* @__PURE__ */jsxRuntimeExports.jsx(CardTitle, {
                      children: "Article Webhooks"
                    }), /* @__PURE__ */jsxRuntimeExports.jsx(CardDescription, {
                      children: "Configure webhooks for automatic article distribution"
                    })]
                  }), /* @__PURE__ */jsxRuntimeExports.jsx(ArticleWebhookDialog, {})]
                })
              }), /* @__PURE__ */jsxRuntimeExports.jsx(CardContent, {
                children: isLoadingWebhooks ? /* @__PURE__ */jsxRuntimeExports.jsx("div", {
                  className: "flex items-center justify-center p-4",
                  children: /* @__PURE__ */jsxRuntimeExports.jsx(LoaderCircle, {
                    className: "h-6 w-6 animate-spin text-primary"
                  })
                }) : webhooks && webhooks.length > 0 ? /* @__PURE__ */jsxRuntimeExports.jsx("div", {
                  className: "space-y-3",
                  children: webhooks.map(webhook => /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                    className: "border rounded-lg p-4",
                    children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                      ...
                      children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                        ...
                        children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                          ...
                          children: [/* @__PURE__ */jsxRuntimeExports.jsx("h4", {
                            ...
                            children: webhook.is_active ? "Active" : "Inactive"
                          })]
                          ...
                          children: [webhook.webhook_url, /* @__PURE__ */jsxRuntimeExports.jsx(ExternalLink, {
                            className: "h-3 w-3"
                          })]
                        })]
                      }), /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
            ...
            children: [/* @__PURE__ */jsxRuntimeExports.jsx("div", {
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                    ...
                    children: [/* @__PURE__ */jsxRuntimeExports.jsx(Settings, {
                      ...
                      children: [/* @__PURE__ */jsxRuntimeExports.jsx("h1", {
                        ...
                        className: "text-muted-foreground",
                        children: "Manage AI, content, and platform settings"
                      })]
                    })]
              ...
              children: /* @__PURE__ */jsxRuntimeExports.jsxs(Tabs, {
                ...
                className: "space-y-6",
                children: [/* @__PURE__ */jsxRuntimeExports.jsxs(TabsList, {
                  className: "grid w-full grid-cols-8 lg:w-auto",
                  children: [/* @__PURE__ */jsxRuntimeExports.jsxs(TabsTrigger, {
                    value: "ai",
                    className: "gap-2",
                    children: [/* @__PURE__ */jsxRuntimeExports.jsx(BrainCircuit, {
                      className: "h-4 w-4"
                    }), "AI Settings"]
                  ...
                  value: "ai",
                  className: "space-y-6",
                  children: /* @__PURE__ */jsxRuntimeExports.jsx(AIConfigurationManager, {})
                }), /* @__PURE__ */jsxRuntimeExports.jsx(TabsContent, {
                  value: "social",
                  className: "space-y-6",
                  children: /* @__PURE__ */jsxRuntimeExports.jsx(SocialMediaManager, {})
                }), /* @__PURE__ */jsxRuntimeExports.jsx(TabsContent, {
                  value: "articles",
                  className: "space-y-6",
                  children: /* @__PURE__ */jsxRuntimeExports.jsx(ArticlesManager, {})
                }), /* @__PURE__ */jsxRuntimeExports.jsx(TabsContent, {
                  value: "keywords",
                  className: "space-y-6",
                  children: /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                    ...
                    children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                      ...
                      children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                        children: [/* @__PURE__ */jsxRuntimeExports.jsx("h2", {
                          ...
                          className: "text-muted-foreground",
                          children: "Import and manage keywords from CSV files"
                        })]
                      }), /* @__PURE__ */jsxRuntimeExports.jsx(KeywordImportDialog, {})]
                    }), /* @__PURE__ */jsxRuntimeExports.jsx("p", {
                      className: "text-sm text-muted-foreground",
                      children: "Use the import button to bulk upload keywords from a CSV file. Keywords help improve content generation and SEO optimization."
                    })]
                  })
                }), /* @__PURE__ */jsxRuntimeExports.jsx(TabsContent, {
                  value: "seo",
                  className: "space-y-6",
                  children: /* @__PURE__ */jsxRuntimeExports.jsx(SEOManager, {})
                }), /* @__PURE__ */jsxRuntimeExports.jsx(TabsContent, {
                  value: "analytics",
                  className: "space-y-6",
                  children: /* @__PURE__ */jsxRuntimeExports.jsx(SearchAnalyticsDashboard, {})
                }), /* @__PURE__ */jsxRuntimeExports.jsx(TabsContent, {
                  value: "users",
                  className: "space-y-6",
                  children: /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                    ...
                    children: [/* @__PURE__ */jsxRuntimeExports.jsx("h2", {
                      ...
                      className: "text-muted-foreground",
                      children: "User role management interface coming soon..."
                    })]
                  })
                }), /* @__PURE__ */jsxRuntimeExports.jsx(TabsContent, {
                  value: "settings",
                  ...
                  children: /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                    ...
                    children: [/* @__PURE__ */jsxRuntimeExports.jsx("h2", {
                      ...
                      className: "text-muted-foreground",
                      children: "Additional platform configuration coming soon..."
                    })]
                  })
                })]
              })
