...
var _a, _b;
import { r as reactExports, R as React, j as jsxRuntimeExports, b as React$1, d as reactDomExports, e as ReactDOM } from "./react-vendor-MTOt5FFF.js";
import { L as LoaderCircle, C as ChevronDown, a as ChevronUp, b as Check, X, c as CircleAlert, R as RefreshCcw, H as Home } from "./icons-CFSiufIk.js";
import { g as getDefaultExportFromCjs } from "./charts-BvRX79AF.js";
import { t as twMerge, c as clsx } from "./utils-DRaK7sdV.js";
import { _ as __assign, b as __rest, c as __spreadArray } from "./supabase-eNUZs_JT.js";
...
var getTagsFromPropsList = (tagName, primaryAttributes, propsList) => {
  ...
  return propsList.filter((props) => {
    ...
    if (typeof props[tagName] !== "undefined") {
      warn(
        "Helmet: ".concat(tagName, ' should be of type "Array". Instead found type "').concat(typeof props[tagName], '"')
      );
    }
    return false;
...
var generateTitleAsString = (type, title, attributes, encode) => {
  ...
  return attributeString ? "<".concat(type, " ").concat(HELMET_ATTRIBUTE, '="true" ').concat(attributeString, ">").concat(encodeSpecialCharacters(
    flattenedTitle,
    encode
  ), "</").concat(type, ">") : "<".concat(type, " ").concat(HELMET_ATTRIBUTE, '="true">').concat(encodeSpecialCharacters(
    flattenedTitle,
    encode
  ), "</").concat(type, ">");
};
...
var getPriorityMethods = ({ metaTags, linkTags, scriptTags, encode }) => {
  ...
  const priorityMethods = {
    ...
    toString: () => (
      ...
      "".concat(getMethodsForTag("meta", meta.priority, encode), " ").concat(getMethodsForTag(
        "link",
        link.priority,
        encode
      ), " ").concat(getMethodsForTag("script", script.priority, encode))
    )
  };
  return {
    priorityMethods,
...
var Helmet = (_b = class extends reactExports.Component {
  ...
  mapNestedChildrenToProps(child, nestedChildren) {
    ...
    switch (child.type) {
      ...
      default:
        throw new Error(
          "<".concat(child.type, " /> elements are self-closing and can not contain children. Refer to our API for more information.")
        );
    }
  }
  ...
  warnOnInvalidChildren(child, nestedChildren) {
    invariant(
      ...
      typeof child.type === "function" ? "You may be attempting to nest <Helmet> components within each other, which is not allowed. Refer to our API for more information." : "Only elements types ".concat(VALID_TAG_NAMES.join(
        ", "
      ), " are allowed. Helmet does not support rendering <").concat(child.type, "> elements. Refer to our API for more information.")
    );
    invariant(
...
const LoadingSpinner$1 = ({ size: size2 = "md", className = "", text }) => {
  const sizeClasses2 = {
    sm: "w-4 h-4",
    md: "w-8 h-8",
    lg: "w-12 h-12"
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center gap-2 ".concat(className), children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "".concat(sizeClasses2[size2], " animate-spin text-primary") }),
    text && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: text })
  ] });
};
const FullPageLoader = ({ text }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen flex items-center justify-center bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingSpinner$1, { size: "lg", text: text || "Loading..." }) });
};
const SEOHead = ({
  title,
  description,
  ...
  const defaultOgImage = "".concat(window.location.origin, "/Cover.png");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Helmet, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("meta", { name: "title", content: fullTitle }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("meta", { name: "description", content: metaDescription }),
    keywords.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("meta", { name: "keywords", content: keywords.join(", ") }),
    author && /* @__PURE__ */ jsxRuntimeExports.jsx("meta", { name: "author", content: author }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("meta", { name: "robots", content: robotsContent }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("meta", { property: "og:image:alt", content: fullTitle }),
    canonicalUrl && /* @__PURE__ */ jsxRuntimeExports.jsx("meta", { property: "og:url", content: canonicalUrl }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("meta", { property: "og:locale", content: locale }),
    ogType === "article" && author && /* @__PURE__ */ jsxRuntimeExports.jsx("meta", { property: "article:author", content: author }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("meta", { name: "twitter:creator", content: twitterHandle }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("meta", { name: "twitter:title", content: fullTitle }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("meta", { name: "twitter:description", content: metaDescription }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("meta", { name: "twitter:image", content: imageUrl }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("meta", { name: "twitter:image:alt", content: fullTitle }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("meta", { name: "theme-color", content: "#0ea5e9" }),
...
const Button = reactExports.forwardRef(
  ({ className, variant, size: size2, asChild = false, onClick, ...props }, ref) => {
  ...
  ({ className, type, ...props }, ref) => {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
        type,
        className: cn(
          "flex h-11 sm:h-10 w-full rounded-md border border-gray-300 bg-white px-3 sm:px-3 py-2.5 sm:py-2 text-base sm:text-sm ring-offset-white file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-gray-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 touch-target transition-all",
          className
        ),
        ref,
        ...props
  ...
  const createScope = () => {
    ...
    return function useScope(scope) {
      ...
      return reactExports.useMemo(
        () => ({ ["__scope".concat(scopeName)]: { ...scope, [scopeName]: contexts } }),
        [scope, contexts]
      );
    };
  };
...
function composeContextScopes$1(...scopes) {
  ...
  const createScope = () => {
    ...
    return function useComposedScopes(overrideScopes) {
      ...
      return reactExports.useMemo(() => ({ ["__scope".concat(baseScope.scopeName)]: nextScopes }), [nextScopes]);
    };
  };
...
var Primitive$3 = NODES$3.reduce((primitive, node) => {
  const Slot2 = /* @__PURE__ */ createSlot$4("Primitive.".concat(node));
...
var Portal$4 = reactExports.forwardRef((props, forwardedRef) => {
  ...
  return container ? ReactDOM.createPortal(/* @__PURE__ */ jsxRuntimeExports.jsx(Primitive$3.div, { ...portalProps, ref: forwardedRef }), container) : null;
});
  ...
  const value = isControlled ? prop : uncontrolledProp;
  {
    ...
    reactExports.useEffect(() => {
      ...
      if (wasControlled !== isControlled) {
        ...
        console.warn(
          "".concat(caller, " is changing from ").concat(from, " to ").concat(to, ". Components should not switch from controlled to uncontrolled (or vice versa). Decide between using a controlled or uncontrolled value for the lifetime of the component.")
        );
      }
...
var Slot$3 = /* @__PURE__ */ createSlot$3("SelectContent.RemoveScroll");
  ...
  (props, forwardedRef) => {
    ...
    reactExports.useEffect(() => {
      if (content) {
        ...
        const handlePointerMove = (event) => {
          var _a2, _b2, _c, _d;
          pointerMoveDelta = {
            x: Math.abs(Math.round(event.pageX) - ((_b2 = (_a2 = triggerPointerDownPosRef.current) == null ? void 0 : _a2.x) != null ? _b2 : 0)),
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      SelectContentProvider,
      {
        ...
        isPositioned,
        searchRef,
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(ReactRemoveScroll, { as: Slot$3, allowPinchZoom: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          FocusScope,
          {
            asChild: true,
...
var DialogTitle$1 = reactExports.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Primitive$3.h2, { id: context.titleId, ...titleProps, ref: forwardedRef });
  }
);
...
var DialogDescription$1 = reactExports.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Primitive$3.p, { id: context.descriptionId, ...descriptionProps, ref: forwardedRef });
  }
);
...
const DialogContent = reactExports.forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogPortal, { children: [
  ...
  /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Content$1,
    {
      ...
      children: [
        children,
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Close, { className: "absolute right-3 sm:right-4 top-3 sm:top-4 rounded-sm opacity-70 ring-offset-white transition-all hover:opacity-100 active:scale-90 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-gray-100 data-[state=open]:text-gray-500 min-w-[44px] min-h-[44px] flex items-center justify-center", children: [
...
const DialogTitle = reactExports.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsxRuntimeExports.jsx(
  Title,
  {
    ref,
    className: cn(
      "text-base sm:text-lg font-semibold leading-tight sm:leading-none tracking-tight text-gray-900 pr-8",
      className
    ),
    ...props
  }
...
var Primitive$2 = NODES$2.reduce((primitive, node) => {
  const Slot2 = /* @__PURE__ */ createSlot$6("Primitive.".concat(node));
  const Node2 = reactExports.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot2 : node;
    if (typeof window !== "undefined") {
...
const hexToHSL = (hex) => {
  ...
  return "".concat(Math.round(h * 360), " ").concat(Math.round(s * 100), "% ").concat(Math.round(l * 100), "%");
};
const applyTheme = (themeData) => {
  ...
  try {
    ...
    if (theme.fonts) {
      ...
      document.body.style.fontFamily = "".concat(theme.fonts.body, ", sans-serif");
    }
...
const getCurrentTheme = (presetName) => {
...
const PasswordStrengthIndicator = ({ password }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2", children: [
    passwordTooShort && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-red-600 font-medium mb-2", children: "⚠ Password must be at least 12 characters" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1", children: [...Array(5)].map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "h-1.5 flex-1 rounded-full transition-all ".concat(i < strength ? getStrengthColor(strength) : "bg-gray-200")
      },
      i
    )) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mt-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-medium ".concat(strength <= 2 ? "text-red-600" : strength === 3 ? "text-yellow-600" : strength === 4 ? "text-blue-600" : "text-green-600"), children: getStrengthLabel(strength) }),
...
class ErrorBoundary extends reactExports.Component {
  ...
  render() {
    if (this.state.hasError) {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-gradient-to-br from-red-50 to-orange-50 flex items-center justify-center px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-lg w-full bg-white rounded-lg shadow-lg p-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 bg-red-100 rounded-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "h-8 w-8 text-red-600" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold text-gray-900", children: "Oops! Something went wrong" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600", children: "We're sorry for the inconvenience" })
          ] })
        ] }),
        false,
...
function LoadingSpinner({
  ...
  const spinner = /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: cn("animate-spin text-blue-600", sizeClasses[size2], className) });
  if (fullScreen) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 flex items-center justify-center bg-white/80 backdrop-blur-sm z-50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
      spinner,
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-gray-600 font-medium", children: "Loading..." })
    ] }) });
  }
  return spinner;
}
  ...
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      Primitive$1.div,
      {
        ...
        "data-value": (_a2 = context.value) != null ? _a2 : void 0,
...
function defaultGetValueLabel(value, max2) {
  return "".concat(Math.round(value / max2 * 100), "%");
}
...
var MenuGroup = reactExports.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Primitive$3.div, { role: "group", ...groupProps, ref: forwardedRef });
  }
);
...
var MenuLabel = reactExports.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Primitive$3.div, { ...labelProps, ref: forwardedRef });
  }
);
...
const DropdownMenuSubTrigger = reactExports.forwardRef(({ className, inset, children, ...props }, ref) => /* @__PURE__ */ jsxRuntimeExports.jsx(
  SubTrigger2,
  {
    ref,
    className: cn(
...
const DropdownMenuCheckboxItem = reactExports.forwardRef(({ className, children, checked, ...props }, ref) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
  CheckboxItem2,
  {
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute left-2 flex h-3.5 w-3.5 items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ItemIndicator2, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "svg",
        {
    ...
    children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute left-2 flex h-3.5 w-3.5 items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ItemIndicator2, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "svg",
        {
          ...
          fill: "currentColor",
          className: "h-2 w-2",
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "12", cy: "12", r: "12" })
        }
      ) }) }),
      children
    ]
...
export {
  ...
  Alert as Q,
  AlertDescription as R,
  Select as S,
  Textarea as T,
  Popover as U,
  PopoverTrigger as V,
  PopoverContent as W,
  getCurrentTheme as X,
  DEFAULT_THEMES as Y,
  Table as Z,
  TableHeader as _,
  SelectTrigger as a,
  ...
  TableCell as a2,
  DropdownMenu as a3,
  DropdownMenuTrigger as a4,
  DropdownMenuContent as a5,
  DropdownMenuItem as a6,
  DialogTrigger as a7,
  SelectValue as b,
  cn as c,
  SelectContent as d,
