;
(function () {
  System.register(['./react-vendor-legacy-BZejsv6W.js', './useAnalytics-legacy-DIC4e8Jy.js', './useLinks-legacy-Bo8FcSit.js', './useProfile-legacy-DrgEb0hd.js', './useSubscription-legacy-CrRihUY4.js', './index-legacy-CvrXsObU.js', './ui-components-legacy-oJhN_-ge.js', './useListings-legacy-Bu1bP5MJ.js', './useTestimonials-legacy-Bw3V7rXz.js', './icons-legacy-C8x4ypXf.js', './charts-legacy-D2SqRQVB.js', './utils-legacy-B2316hnE.js', './data-legacy-BmYdDdMQ.js', './supabase-legacy-CQONYrP8.js', './state-stores-legacy-80VekGrm.js', './three-addons-legacy-COT_Kqtz.js', './three-legacy-VFAp7wzH.js', './forms-legacy-BImVIBp0.js'], function (exports, module) {
    'use strict';

    var jsxRuntimeExports, Link, useSearchParams, useNavigate, reactExports, useAnalytics, useLinks, useProfile, useSubscription, useToast, Card, CardHeader, CardTitle, CardDescription, Progress, CardContent, LoadingSpinner, Dialog, DialogContent, DialogHeader, DialogTitle, DialogDescription, useListings, useTestimonials, CircleAlert, Circle, CircleCheckBig, Eye, Users, MousePointerClick, TrendingUp, Copy, ExternalLink, PartyPopper, Check;
    return {
      setters: [module => {
        jsxRuntimeExports = module.j;
        Link = module.L;
        useSearchParams = module.l;
        ...
        useListings = module.u;
      }, module => {
        useTestimonials = module.u;
      }, module => {
        ...
        Eye = module.E;
        Users = module.U;
        MousePointerClick = module.au;
        TrendingUp = module.T;
        Copy = module.ae;
        ExternalLink = module.h;
        PartyPopper = module.av;
        Check = module.b;
      ...
      execute: function () {
        ...
        function ProfileCompletionWidget() {
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs(Card, {
            ...
            children: [/* @__PURE__ */jsxRuntimeExports.jsxs(CardHeader, {
              children: [/* @__PURE__ */jsxRuntimeExports.jsx("div", {
                ...
                children: /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsxs(CardTitle, {
                    ...
                    children: [completionPercentage < 50 ? /* @__PURE__ */jsxRuntimeExports.jsx(CircleAlert, {
                      className: "w-5 h-5 text-orange-500"
                    }) : /* @__PURE__ */jsxRuntimeExports.jsx(Circle, {
                      className: "w-5 h-5 text-blue-500"
                    }), "Profile Completion"]
                  }), /* @__PURE__ */jsxRuntimeExports.jsxs(CardDescription, {
                    children: [completionPercentage, "% complete - ", completedSteps, " of ", totalSteps, " steps done"]
                  })]
                })
              ...
              className: "space-y-4",
              children: [nextStep && /* @__PURE__ */jsxRuntimeExports.jsx("div", {
                ...
                children: [/* @__PURE__ */jsxRuntimeExports.jsxs("summary", {
                  className: "cursor-pointer text-sm font-medium text-gray-700 hover:text-gray-900 list-none flex items-center gap-2",
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx("span", {
                  ...
                  children: steps.map(step => /* @__PURE__ */jsxRuntimeExports.jsxs(Link, {
                    to: step.link,
                    className: "flex items-start gap-3 p-2 rounded-lg hover:bg-white transition-colors group/item",
                    children: [step.completed ? /* @__PURE__ */jsxRuntimeExports.jsx(CircleCheckBig, {
        ...
        function Overview() {
          ...
          const getUnlockedFeatures = planName => {
            const features = {
              starter: ["20 active listings", "15 custom links", "10 testimonials", "90-day analytics", "Lead export to CSV"],
              professional: ["Unlimited listings", "Unlimited custom links", "Unlimited testimonials", "Unlimited analytics history", "Custom domain support", "Premium themes with 3D effects", "Priority email support"],
              team: ["Everything in Professional", "Multi-agent dashboard", "Team analytics", "White-label branding", "API access", "Dedicated account manager"]
            };
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
            ...
            children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
              children: [/* @__PURE__ */jsxRuntimeExports.jsxs("h2", {
                ...
                children: [greeting, profile?.full_name && !isNewUser && /* @__PURE__ */jsxRuntimeExports.jsxs("span", {
            ...
            }), /* @__PURE__ */jsxRuntimeExports.jsx(ProfileCompletionWidget, {}), /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
              ...
              children: [/* @__PURE__ */jsxRuntimeExports.jsx(StatCard, {
                ...
                icon: /* @__PURE__ */jsxRuntimeExports.jsx(MousePointerClick, {
              ...
              children: [/* @__PURE__ */jsxRuntimeExports.jsxs(Card, {
                children: [/* @__PURE__ */jsxRuntimeExports.jsx(CardHeader, {
                  ...
                  children: recentLeads.length > 0 ? /* @__PURE__ */jsxRuntimeExports.jsx("div", {
                    className: "space-y-2 sm:space-y-3",
                    children: recentLeads.slice(0, 5).map(lead => /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                      ...
                      children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                        ...
                        className: `px-2 py-1 text-xs rounded-full flex-shrink-0 font-medium ${lead.status === "new" ? "bg-blue-100 text-blue-700" : lead.status === "contacted" ? "bg-yellow-100 text-yellow-700" : "bg-green-100 text-green-700"}`,
                    ...
                    children: [/* @__PURE__ */jsxRuntimeExports.jsx("div", {
                      className: "inline-flex items-center justify-center w-12 h-12 rounded-full bg-blue-100 mb-3",
                      children: /* @__PURE__ */jsxRuntimeExports.jsx(Users, {
                        className: "h-6 w-6 text-blue-600"
                      })
                    }), /* @__PURE__ */jsxRuntimeExports.jsx("h4", {
                      className: "font-semibold text-sm mb-1",
                      children: "Start Capturing Leads"
                    }), /* @__PURE__ */jsxRuntimeExports.jsx("p", {
                      className: "text-xs text-muted-foreground mb-3 max-w-xs mx-auto",
                      children: "Share your profile link to start receiving inquiries from potential clients"
                    }), profile?.username && /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                      className: "flex items-center justify-center gap-2 p-2 bg-muted rounded-lg max-w-xs mx-auto",
                      children: [/* @__PURE__ */jsxRuntimeExports.jsxs("code", {
                        className: "text-xs truncate",
                        children: ["agentbio.net/", profile.username]
                ...
                children: [/* @__PURE__ */jsxRuntimeExports.jsx(CardHeader, {
                  ...
                  children: links.length > 0 ? /* @__PURE__ */jsxRuntimeExports.jsx("div", {
                    className: "space-y-2 sm:space-y-3",
                    children: links.sort((a, b) => (b.click_count || 0) - (a.click_count || 0)).slice(0, 5).map(link => /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                      className: "flex items-center justify-between py-2 sm:py-2.5 border-b border-border last:border-0 gap-2 min-h-[44px]",
                      children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                        className: "flex-1 min-w-0",
                        children: [/* @__PURE__ */jsxRuntimeExports.jsx("p", {
                        ...
                        className: "flex items-center gap-1 text-sm sm:text-base text-muted-foreground flex-shrink-0",
                        children: [/* @__PURE__ */jsxRuntimeExports.jsx(MousePointerClick, {
                          className: "h-3 w-3 sm:h-4 sm:w-4"
                        }), /* @__PURE__ */jsxRuntimeExports.jsx("span", {
                          className: "font-medium",
                          children: link.click_count || 0
                        })]
                      })]
                    }, link.id))
                  }) : /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                    className: "text-center py-6 sm:py-8",
                    children: [/* @__PURE__ */jsxRuntimeExports.jsx("div", {
                      className: "inline-flex items-center justify-center w-12 h-12 rounded-full bg-purple-100 mb-3",
                      children: /* @__PURE__ */jsxRuntimeExports.jsx(MousePointerClick, {
                      ...
                      className: "text-xs text-muted-foreground mb-3 max-w-xs mx-auto",
                      children: "Add links to your website, social media, and other profiles"
                    }), /* @__PURE__ */jsxRuntimeExports.jsxs("a", {
                      href: "/dashboard/links",
                      className: "inline-flex items-center gap-1 text-xs text-blue-600 hover:text-blue-700 font-medium",
                      children: ["Manage Links ", /* @__PURE__ */jsxRuntimeExports.jsx(ExternalLink, {
                        className: "h-3 w-3"
                      })]
                    })]
                  })
              ...
              children: /* @__PURE__ */jsxRuntimeExports.jsxs(DialogContent, {
                ...
                children: [/* @__PURE__ */jsxRuntimeExports.jsxs(DialogHeader, {
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx("div", {
                    ...
                    children: /* @__PURE__ */jsxRuntimeExports.jsx(PartyPopper, {
                      className: "w-8 h-8 text-green-600"
                    })
                  }), /* @__PURE__ */jsxRuntimeExports.jsxs(DialogTitle, {
                    className: "text-center text-2xl",
                    children: ["🎉 Welcome to ", subscription?.plan_name, "!"]
                  }), /* @__PURE__ */jsxRuntimeExports.jsx(DialogDescription, {
                    className: "text-center pt-2",
                    children: "Your subscription is now active. Here's what you just unlocked:"
                  })]
                }), /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsxs("h4", {
                    ...
                    className: "space-y-2",
                    children: getUnlockedFeatures(subscription?.plan_name).map((feature, index) => /* @__PURE__ */jsxRuntimeExports.jsxs("li", {
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx("p", {
                    ...
                    children: "A confirmation email with your receipt has been sent to your email address."
                  }), /* @__PURE__ */jsxRuntimeExports.jsx("button", {
        ...
        function StatCard({
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
            className: "bg-white rounded-lg border border-gray-200 p-3 sm:p-4 md:p-6 hover:shadow-md transition-shadow active:scale-[0.98] cursor-pointer",
            children: [/* @__PURE__ */jsxRuntimeExports.jsx("div", {
              className: "flex items-center mb-2 sm:mb-3 md:mb-4",
              children: /* @__PURE__ */jsxRuntimeExports.jsx("div", {
                className: "p-1.5 sm:p-2 bg-gray-50 rounded-lg",
                children: icon
              })
            }), /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
              children: [/* @__PURE__ */jsxRuntimeExports.jsx("p", {
                ...
                className: "text-xl sm:text-2xl font-bold text-gray-900 break-all",
                children: value
              })]
            })]
          });
