...
(function () {
  System.register(['./react-vendor-legacy-BZejsv6W.js', './ui-components-legacy-oJhN_-ge.js', './icons-legacy-C8x4ypXf.js'], function (exports, module) {
    ...
    var jsxRuntimeExports, Link, Helmet, ChevronRight, Home;
    return {
      setters: [module => {
      ...
      execute: function () {
        ...
        function Breadcrumbs({
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
            children: [/* @__PURE__ */jsxRuntimeExports.jsx(Helmet, {
              ...
              children: /* @__PURE__ */jsxRuntimeExports.jsx("ol", {
                ...
                children: allItems.map((item, index) => {
                  ...
                  return /* @__PURE__ */jsxRuntimeExports.jsxs("li", {
                    ...
                    children: [index > 0 && /* @__PURE__ */jsxRuntimeExports.jsx(ChevronRight, {
                      className: "h-4 w-4 mx-2 text-muted-foreground",
                      "aria-hidden": "true"
                    }), isLast ? /* @__PURE__ */jsxRuntimeExports.jsxs("span", {
                      className: "text-foreground font-medium",
                      "aria-current": "page",
                      children: [isFirst && /* @__PURE__ */jsxRuntimeExports.jsx(Home, {
