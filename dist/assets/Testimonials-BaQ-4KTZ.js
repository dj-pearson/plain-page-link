...
import { D as Dialog, l as DialogContent, m as DialogHeader, n as DialogTitle, G as DialogDescription, L as Label, I as Input, T as Textarea, O as DialogFooter, j as Button } from "./ui-components-CbrOUI4e.js";
import { i as Star, a6 as Upload, X, b as Check, ae as Copy, u as Share2, h as ExternalLink, M as Mail, q as MessageSquare, aw as Plus, Q as Quote, ay as SquarePen, az as Trash2 } from "./icons-CFSiufIk.js";
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 mt-2", children: [1, 2, 3, 4, 5].map((star) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              Star,
              {
                className: "h-8 w-8 transition-colors ".concat(star <= formData.rating ? "fill-yellow-400 text-yellow-400" : "text-gray-300")
              }
            )
          },
          star
...
function RequestTestimonialModal({
  ...
  const reviewURL = "".concat(window.location.origin, "/").concat(username, "/review");
  ...
  const smsTemplate = "Hi! Would you mind leaving a quick review of your experience? It helps me serve clients better: ".concat(reviewURL, " Thanks! - ").concat(agentName);
  const copyToClipboard = async (text, type = "url") => {
    try {
      ...
      toast({
        title: "Copied!",
        description: "".concat(type === "url" ? "Review link" : "Email template", " copied to clipboard")
      });
    } catch (err) {
      toast({
  ...
  const shareViaEmail = () => {
    const subject = encodeURIComponent("Request for Testimonial - ".concat(agentName));
  ...
  const shareViaSMS = () => {
    ...
    window.open("sms:?&body=".concat(sms));
  };
...
function Testimonials() {
  ...
  const renderStars = (rating) => {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1", children: [...Array(5)].map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      Star,
      {
        className: "h-4 w-4 ".concat(i < rating ? "fill-yellow-400 text-yellow-400" : "text-gray-300")
      },
      i
    )) });
  };
