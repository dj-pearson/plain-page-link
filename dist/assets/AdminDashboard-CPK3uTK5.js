import { r as reactExports, j as jsxRuntimeExports, N as Navigate, L as Link } from "./react-vendor-MTOt5FFF.js";
import { u as useAuthStore } from "./state-stores-BzsyoW3J.js";
import { D as Dialog, a7 as DialogTrigger, j as Button, l as DialogContent, m as DialogHeader, n as DialogTitle, G as DialogDescription, L as Label, I as Input, S as Select, a as SelectTrigger, b as SelectValue, d as SelectContent, e as SelectItem, w as Switch, O as DialogFooter, C as Card, f as CardHeader, g as CardTitle, h as CardDescription, o as CardContent, B as Badge, T as Textarea, J as Tabs, K as TabsList, M as TabsTrigger, N as TabsContent } from "./ui-components-CbrOUI4e.js";
...
function useAIConfiguration() {
  ...
  const updateConfigMutation = useMutation({
    mutationFn: async ({ key, value }) => {
      ...
      const { error } = await supabase.from("ai_configuration").update({
        ...
        updated_by: (_a = (await supabase.auth.getUser()).data.user) == null ? void 0 : _a.id
      }).eq("setting_key", key);
      if (error) throw error;
    },
    onSuccess: () => {
  ...
  const getConfigValue = (key) => {
    var _a;
    const item = (_a = configQuery.data) == null ? void 0 : _a.find((c) => c.setting_key === key);
    if (!item) return "";
    try {
...
function AIConfigurationManager() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Select,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: models == null ? void 0 : models.map((model) => /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectItem, { value: model.model_id, children: [
                    model.model_name,
                    " (",
                    model.provider,
                    ")"
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: models == null ? void 0 : models.map((model) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between p-4 border rounded-lg gap-4", children: [
  ...
  const createPostMutation = useMutation({
    mutationFn: async (post) => {
      ...
      const { data, error } = await supabase.from("social_media_posts").insert({
        ...post,
        created_by: (_a = userData.user) == null ? void 0 : _a.id
      }).select().single();
      if (error) throw error;
      return data;
    },
...
function CreateSocialPostDialog() {
  ...
  const handleSave = () => {
    ...
    createPost({
      ...
      post_title: postTitle || "".concat(contentType, " - ").concat((/* @__PURE__ */ new Date()).toLocaleDateString()),
...
function SocialMediaManager() {
  ...
  const filteredPosts = activeTab === "all" ? posts : posts == null ? void 0 : posts.filter((p) => p.status === activeTab);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: activeTab, className: "space-y-4 mt-6", children: filteredPosts && filteredPosts.length > 0 ? filteredPosts.map((post) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border rounded-lg p-4 hover:border-primary transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "".concat(getStatusColor(post.status), " text-white"), children: post.status })
            ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: marketingPosts && marketingPosts.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: marketingPosts.map((post) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border rounded-lg p-4 space-y-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1", children: (_a = content.hashtags) == null ? void 0 : _a.map((tag, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "text-xs", children: tag }, idx)) })
          ] })
        ] }, post.id);
  ...
  const createArticleMutation = useMutation({
    mutationFn: async (article) => {
      ...
      const { data, error } = await supabase.from("articles").insert({
        ...article,
        author_id: (_a = userData.user) == null ? void 0 : _a.id
      }).select().single();
      if (error) throw error;
      return data;
    },
  ...
  const republishArticleMutation = useMutation({
    ...
    onSuccess: (data) => {
      if (data == null ? void 0 : data.success) {
        ...
        ue.error((data == null ? void 0 : data.error) || "Failed to distribute article");
      }
    },
    onError: (error) => {
  ...
  const importKeywordsMutation = useMutation({
    mutationFn: async (keywords2) => {
      ...
      const response = await fetch(
        "".concat(supabase.supabaseUrl, "/functions/v1/import-keywords"),
        {
          method: "POST",
          headers: {
  ...
  const createWebhookMutation = useMutation({
    mutationFn: async (webhook) => {
      ...
      const { data, error } = await supabase.from("article_webhooks").insert({
        ...webhook,
        user_id: (_a = userData.user) == null ? void 0 : _a.id
      }).select().single();
      if (error) throw error;
      return data;
    },
  ...
  const testWebhookMutation = useMutation({
    ...
    onSuccess: (data) => {
      if (data == null ? void 0 : data.success) {
        ...
        ue.error((data == null ? void 0 : data.error) || "Test failed");
      }
    },
    onError: (error) => {
      ue.error("Failed to test webhook: " + error.message);
...
function CreateArticleDialog() {
  ...
  const handleGenerate = () => {
    if (mode === "keyword") {
      ...
      generateArticle({
        topic: selectedKeyword == null ? void 0 : selectedKeyword.keyword,
        category,
...
function useContentSuggestions() {
  ...
  const writeArticleMutation = useMutation({
    mutationFn: async (suggestion) => {
      ...
      await supabase.from("content_suggestions").update({ status: "completed", generated_article_id: (_b = (_a = response.data) == null ? void 0 : _a.article) == null ? void 0 : _b.id }).eq("id", suggestion.id);
      return response.data;
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["content-suggestions"] });
...
function ContentSuggestionsCard() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center p-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-8 w-8 animate-spin text-primary" }) }) : suggestions.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: suggestions.map((suggestion) => {
        var _a;
        return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border rounded-lg p-4 hover:border-primary transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between mb-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1", children: [
              getPriorityIcon(suggestion.priority),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold", children: suggestion.topic }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "".concat(getStatusColor(suggestion.status), " text-white text-xs"), children: suggestion.status || "pending" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2 mt-2", children: [
              ...
              (_a = suggestion.keywords) == null ? void 0 : _a.slice(0, 3).map((keyword, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "secondary", className: "gap-1", children: [
...
function ArticlesManager() {
  ...
  const filteredArticles = activeTab === "all" ? articles : articles == null ? void 0 : articles.filter((a) => a.status === activeTab);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { value: activeTab, onValueChange: setActiveTab, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: activeTab, className: "space-y-4 mt-6", children: filteredArticles && filteredArticles.length > 0 ? filteredArticles.map((article) => {
          var _a, _b;
          return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border rounded-lg p-4 hover:border-primary transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold text-lg", children: article.title }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "".concat(getStatusColor(article.status), " text-white"), children: article.status })
              ] }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2 mb-3", children: [
                ...
                article.keyword_id && /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "secondary", className: "gap-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Hash, { className: "h-3 w-3" }),
                  ((_a = keywords == null ? void 0 : keywords.find((k) => k.id === article.keyword_id)) == null ? void 0 : _a.keyword) || "Keyword"
                ] }),
                (_b = article.tags) == null ? void 0 : _b.slice(0, 2).map((tag, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", children: tag }, idx))
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 text-xs text-muted-foreground", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: isLoadingKeywords ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-6 w-6 animate-spin text-primary" }) }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-4 mb-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border rounded-lg p-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-bold", children: (keywords == null ? void 0 : keywords.length) || 0 })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border rounded-lg p-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Unused" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-bold text-green-600", children: (keywords == null ? void 0 : keywords.filter((k) => k.usage_count === 0).length) || 0 })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border rounded-lg p-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Most Used" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-bold text-blue-600", children: Math.max(...(keywords == null ? void 0 : keywords.map((k) => k.usage_count)) || [0]) })
          ] })
        ] }),
