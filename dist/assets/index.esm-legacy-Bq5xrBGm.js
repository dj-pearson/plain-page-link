    ...
    return {
      execute: function () {
        exports({
          ...
          f: getModularInstance,
          g: getApp,
          h: isIndexedDBAvailable,
          i: initializeApp,
          j: areCookiesEnabled,
          r: registerVersion,
          v: validateIndexedDBOpenable
        });
         ...
         * @internal
         */
        const DEFAULT_ENTRY_NAME = exports("D", '[DEFAULT]');
         ...
         * @internal
         */
        const _apps = exports("a", new Map());
        /**
         * @internal
         */
        const _serverApps = exports("e", new Map());
        /**
         ...
         */
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        const _components = exports("b", new Map());
        /**
