...
import { c as cn, L as Label, S as Select, a as SelectTrigger, b as SelectValue, d as SelectContent, e as SelectItem, j as Button, B as Badge, J as Tabs, K as TabsList, M as TabsTrigger, N as TabsContent } from './ui-components-DLW4dShh.js';
import { aL as Minus, ac as TrendingDown, T as TrendingUp, C as ChevronDown, U as Users, K as DollarSign, j as Target, ad as Lightbulb, c as CircleAlert, J as CircleCheckBig, aj as FileText, e as Calendar, a1 as Download, B as BarChart3 } from './icons-Bf8A6sFa.js';
import { e as eachDayOfInterval, a as format, u as ue, s as subDays, d as startOfMonth, g as endOfMonth } from './utils-BhOeSegx.js';
  ...
  static generateInsights(current, previous, sources) {
    ...
    if (sources.length > 0) {
      ...
      if (bestSource.conversionRate > 15) {
        insights.push(
          `🌟 ${bestSource.source} is your best performing source at ${bestSource.conversionRate.toFixed(
            1
          )}% conversion rate`
        );
      }
...
function ReportBuilder({
  ...
  const handleGenerateReport = async () => {
    ...
    try {
      ...
      if (format2 === "csv") {
        const filename = `${reportType}_report_${format2(
          start,
          "yyyy-MM-dd"
        )}_to_${format2(end, "yyyy-MM-dd")}`;
