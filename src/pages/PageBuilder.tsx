...
export default function PageBuilderEditor() {
  ...
  const handleUpdateBlockStyle = (blockId: string, style: BlockStyle) => {
    if (!page) return;
    const updatedBlocks = page.blocks.map((b) => (b.id === blockId ? { ...b, style } : b));
  ...
  const templatesByCategory = blockTemplates.reduce(
    (acc, t) => {
            ...
            >
              {page.blocks.length === 0 ? (
                <div className="text-center py-20">
                  ...
                  <p className="font-semibold text-gray-500 text-lg">Start building your page</p>
