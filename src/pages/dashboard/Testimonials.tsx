...
import {
  ...
  EditTestimonialFormData,
} from '@/components/modals/EditTestimonialModal';
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Showcase client reviews and success stories</p>
        </div>
            ...
            >
              ...
              <div className="flex items-center justify-between pt-4 border-t border-border">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-medium text-foreground">{testimonial.client_name}</div>
      ...
      <div className="bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-900 rounded-lg p-4">
        <p className="text-sm text-blue-800 dark:text-blue-200">
          ...
          <strong>Tip:</strong> Featured testimonials will be prominently displayed on your public
          profile. Ask satisfied clients for reviews after successful transactions!
        </p>
      </div>
