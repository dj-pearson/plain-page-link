...
const LANDING_FAQS = [
  ...
  },
  {
    ...
    answer:
      'Yes! Showcasing sold properties is one of the most powerful social proof elements for real estate agents. AgentBio lets you create a dedicated sold properties section with photos, addresses, sale prices, and closing dates. This demonstrates your track record and expertise to potential clients browsing your Instagram bio page.',
  },
  {
    question: 'How do I capture leads with AgentBio?',
    answer:
      "AgentBio includes built-in lead capture forms for buyers, sellers, and home valuations. Interested clients can submit their information directly from your portfolio link. You'll receive email notifications and can manage all leads from your dashboard with detailed analytics about lead sources.",
  },
  {
    question: 'Is AgentBio mobile-friendly?',
    answer:
      'Yes, all AgentBio portfolios are fully mobile-optimized and responsive. Your portfolio will look professional on any device - smartphones, tablets, and desktop computers. Most home buyers browse on mobile devices, so mobile optimization is a core feature.',
  },
  {
    question: 'Can I customize my AgentBio portfolio?',
    answer:
      'Absolutely! You can customize colors, fonts, layout, profile photo, bio, social media links, and all content. Premium plans offer additional customization options including custom domains, advanced themes, and white-label branding to match your brokerage or personal brand.',
  },
  {
    question: 'Do I need technical skills to use AgentBio?',
    answer:
      'No technical skills required! AgentBio is designed to be simple and intuitive. You can create your professional portfolio in minutes by filling out your profile, uploading photos, and adding listings. Our drag-and-drop interface makes customization easy for anyone.',
  },
  {
    question: 'How do I share my AgentBio portfolio?',
    answer:
      "You'll get a unique link (agentbio.net/yourname) that you can share anywhere - social media profiles, email signatures, business cards, listing presentations, or text messages. You can also share individual listings directly from your portfolio.",
  },
];
    ...
    '@graph': [
      {
        ...
        description:
          'Turn your Instagram into a lead-generating real estate portfolio. Showcase listings, capture inquiries & book showings from one mobile-optimized bio page.',
        publisher: {
      ...
      organizationSchema,
      {
        ...
        // aggregateRating removed (US-111). It claimed ratingValue 4.8
        // over 523 reviews, both invented. Google renders stars in
        // search results from this field, so a fabricated value is a
        // false claim published to everyone who searches — and a
  ...
  return (
    <>
      ...
      <main id="main-content" className="min-h-screen bg-background" tabIndex={-1}>
        ...
        <section
          className="py-12 bg-glass-background/30 border-y border-glass-border"
          aria-label="Key benefits"
        >
          <div className="container mx-auto px-4">
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
              <div className="flex items-start gap-3">
                <div className="flex-shrink-0 w-6 h-6 rounded-full bg-gradient-to-r from-[#80d0c7] to-[#a1c4fd] flex items-center justify-center text-white text-sm font-light">
                  ✓
                </div>
                <p className="text-sm glass-body leading-relaxed">
                  Showcase active & sold listings with full photo galleries
                </p>
              </div>
              <div className="flex items-start gap-3">
                <div className="flex-shrink-0 w-6 h-6 rounded-full bg-gradient-to-r from-[#80d0c7] to-[#a1c4fd] flex items-center justify-center text-white text-sm font-light">
                ...
                <p className="text-sm glass-body leading-relaxed">
                  Capture buyer inquiries & seller leads automatically
                </p>
              </div>
              <div className="flex items-start gap-3">
                <div className="flex-shrink-0 w-6 h-6 rounded-full bg-gradient-to-r from-[#80d0c7] to-[#a1c4fd] flex items-center justify-center text-white text-sm font-light">
                ...
                <p className="text-sm glass-body leading-relaxed">
                  Schedule showings directly from your Instagram bio
                </p>
              </div>
              <div className="flex items-start gap-3">
                <div className="flex-shrink-0 w-6 h-6 rounded-full bg-gradient-to-r from-[#80d0c7] to-[#a1c4fd] flex items-center justify-center text-white text-sm font-light">
                ...
                <p className="text-sm glass-body leading-relaxed">
                  Professional agent profile with reviews & credentials
                </p>
              </div>
            </div>
            <div className="text-center mt-8">
              <p className="text-sm text-muted-foreground font-light">
                {MARKETING_COPY.joinLine} • No credit card required
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <header className="text-center mb-16">
              ...
              <p className="text-xl glass-body max-w-2xl mx-auto">
                Linktree wasn't built for real estate. AgentBio was. Here's why agents are
                switching...
              </p>
            </header>
        ...
        <section
          ...
          aria-labelledby="converts-heading"
        >
          ...
          <div className="container mx-auto px-4 relative z-10">
            <header className="text-center mb-16">
              ...
              <p className="text-xl glass-body max-w-3xl mx-auto">
                Stop losing leads to complicated websites. Give your Instagram followers exactly
              ...
              <div className="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div className="space-y-4">
                  ...
                  <p className="glass-body leading-relaxed mb-6">
                    ...
                    when you send clients to your traditional website:
                  </p>
                ...
                <div className="space-y-4">
                  ...
                  <p className="glass-body leading-relaxed mb-6">
                    ...
                    center, and has contact buttons in thumb-reach. Everything a buyer needs to take
                    the next step.
                  </p>
                  <div className="space-y-3">
                    <div className="flex items-start gap-3">
        ...
        >
          <div className="container mx-auto px-4">
            <header className="text-center mb-16">
              ...
              <p className="text-xl glass-body max-w-3xl mx-auto">
                Not just another link tool—AgentBio includes everything real estate agents need to
                convert social media traffic into closed deals
              </p>
            </header>
        ...
        <section className="py-20 bg-background" aria-labelledby="faq-heading">
          <div className="container mx-auto px-4">
            <header className="text-center mb-16">
              ...
              <p className="text-xl glass-body max-w-2xl mx-auto">
                Everything you need to know about creating your professional real estate agent
                portfolio
              </p>
            </header>
        ...
        <section className="py-20 relative overflow-hidden" aria-labelledby="cta-heading">
          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            <h2 id="cta-heading" className="text-4xl md:text-5xl font-light tracking-tight mb-4">
              <span className="glass-heading">Ready to Turn Instagram Followers Into Clients?</span>
            </h2>
            <p className="text-xl mb-8 glass-body max-w-2xl mx-auto">
              {MARKETING_COPY.joinLine} using AgentBio to showcase listings, capture leads, and book
              showings from one mobile-optimized bio page
            </p>
            <Link
              to="/auth/register"
