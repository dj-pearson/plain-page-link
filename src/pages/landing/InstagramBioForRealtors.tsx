          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <p className="text-base md:text-lg glass-body leading-relaxed">
                <strong>
                  Real estate agents turn their Instagram bio into a lead generation machine
                </strong>{' '}
                by placing a specialized link in their profile that showcases property listings,
                captures buyer and seller inquiries, and books showing appointments. Unlike generic
                link tools, AgentBio is built specifically for real estate professionals to convert
                Instagram followers into qualified leads through mobile-optimized portfolio pages.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="max-w-4xl mx-auto grid md:grid-cols-3 gap-8">
              <div className="p-6 rounded-xl bg-glass-background backdrop-blur-md border border-glass-border">
                ...
                <p className="glass-body">
                  Generic links can't display property photos, pricing, or details. Your followers
                  have to leave Instagram to see what you're selling.
                </p>
              </div>
              ...
              <div className="p-6 rounded-xl bg-glass-background backdrop-blur-md border border-glass-border">
                ...
                <p className="glass-body">
                  Basic contact forms don't differentiate buyers from sellers or qualify leads.
              ...
              <div className="p-6 rounded-xl bg-glass-background backdrop-blur-md border border-glass-border">
                ...
                <p className="glass-body">
                  You can't tell if someone wants to buy, sell, or just browse. All leads look the
                  same.
                </p>
              </div>
            </div>
          ...
          <div className="container mx-auto px-4">
            <header className="text-center mb-16">
              ...
              <p className="text-xl glass-body max-w-3xl mx-auto">
                5 simple steps to transform your Instagram profile into a lead-generating real
                estate portfolio
              </p>
            </header>
        ...
        <section className="py-20 bg-background/50" id="examples">
          <div className="container mx-auto px-4">
            <header className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-light tracking-tight text-foreground mb-4">
                <span className="glass-heading">
                  Instagram Bio Examples from Top-Performing Agents
                </span>
              </h2>
            </header>
        ...
        <section className="py-20 bg-background">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-4xl md:text-5xl font-light tracking-tight mb-4">
              <span className="glass-heading">
                Transform Your Instagram Bio into a Lead Machine
              </span>
            </h2>
