...
export default function Register() {
  ...
  const { signUp, signInWithGoogle, signInWithApple, isLoading, error, clearError, user, session } =
    useAuthStore();
  ...
  return (
    <main id="main-content" tabIndex={-1} className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-5/12 relative overflow-hidden bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900">
        ...
        <div
          className="absolute bottom-1/3 right-0 w-80 h-80 bg-indigo-500/15 rounded-full blur-3xl animate-pulse"
          style={{ animationDelay: '1s' }}
        />
        <div
          className="absolute top-2/3 left-1/4 w-56 h-56 bg-cyan-500/10 rounded-full blur-3xl animate-pulse"
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 w-full">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              {[
                ...
                },
                {
                  ...
                  desc: 'Track engagement patterns in real-time',
                },
                // "SOC 2 compliant" was claimed here with no
                // attestation anywhere — no report, no auditor,
                // no Trust Center (US-111). This says what the
                // code actually does.
                {
                  icon: Shield,
                  title: 'Enterprise Security',
                  desc: MARKETING_COPY.securityClaims[0] + ', encrypted at rest and in transit',
                },
              ].map((feature) => (
                <div
                  key={feature.title}
            ...
            <div className="flex items-center gap-4">
              <div className="flex -space-x-2">
                {['JD', 'MK', 'AL', 'RS'].map((initials, i) => (
                  <div
                    ...
                    style={{
                      // US-206: the 500-level shades gave white 10px bold text 2.42-4.23:1.
                      // These are the 600/700 steps of the same hues, all >= 4.9:1.
              ...
              <div className="text-xs text-blue-200/50">
                {/* Said "2,500+" while the landing page said
                                    "5,000+" — two invented numbers for the same
                                    thing, one click apart (US-111). */}
                {MARKETING_COPY.joinLine.replace('Join ', '')}
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-6 text-xs text-blue-200/30">
            <Link to="/privacy" className="hover:text-blue-200/60 transition-colors">
              Privacy
            </Link>
            <Link to="/terms" className="hover:text-blue-200/60 transition-colors">
              Terms
            </Link>
            ...
            {emailVerificationSent ? (
              <div>
                ...
                <div className="text-center mb-8">
                  ...
                  <p className="text-sm font-semibold text-gray-900 break-all">{registeredEmail}</p>
                </div>
                ...
                <form onSubmit={handleVerifyOtp} className="space-y-6">
                  ...
                  <div className="text-center">
                    <p className="text-xs text-gray-500 mb-1.5">Didn't receive the code?</p>
                    <button
                      type="button"
                ...
                <div className="mt-6 p-4 bg-blue-50 border border-blue-100 rounded-xl">
                  <p className="text-xs text-blue-700">
                    <strong>Tip:</strong> Check your spam folder if you don't see the email. The
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <div className="absolute right-3.5 top-1/2 -translate-y-1/2">
                        {isChecking && (
                          <UsernameLoader className="h-4 w-4 animate-spin text-blue-500" />
                        )}
