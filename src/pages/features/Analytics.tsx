...
export default function Analytics() {
  ...
  const pageSchema = {
    ...
    description:
      'Track which listings get the most views, where leads come from, and which properties generate inquiries. Data-driven insights for real estate agents.',
  };
  ...
  return (
    <>
      <SEOHead
        ...
        canonicalUrl={getCanonicalUrl('/features/analytics')}
        schema={schema}
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <p className="text-base md:text-lg glass-body leading-relaxed">
                <strong>AgentBio's real estate analytics give agents data-driven insights</strong>{' '}
                into which property listings get the most views, where leads come from (Instagram
                Story, Post, or DM), which links get clicked most, and how visitors engage with
                their bio page. Unlike generic analytics, AgentBio tracks real estate-specific
                metrics like listing views per property, lead source attribution, and conversion
                rates from social media traffic—helping agents optimize their marketing and focus on
              ...
              <div className="p-8 rounded-xl bg-glass-background backdrop-blur-md border border-glass-border">
                ...
                <div className="space-y-4">
                  {[
                    {
                      time: '2 minutes ago',
                      action: 'Someone viewed your $650K listing from Instagram Story',
                      color: 'blue',
                    },
                    {
                      time: '8 minutes ago',
                      action: 'New lead submitted: Buyer inquiry for 3-bed homes',
                      color: 'green',
                    },
                    {
                      time: '15 minutes ago',
                      action: 'Showing appointment booked for 123 Main St',
                      color: 'purple',
                    },
                    {
                      time: '22 minutes ago',
                      action: '4 people viewed your profile in the last hour',
                      color: 'blue',
                    },
                    {
                      time: '35 minutes ago',
                      action: 'Home valuation request submitted',
                      color: 'green',
                    },
                  ].map((activity, i) => (
            ...
            <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-8">
              <div className="p-6 rounded-xl bg-glass-background backdrop-blur-md border border-glass-border">
                <p className="glass-body italic mb-4">
                  "I thought my Instagram Reels were driving all my leads. Analytics showed 90%
                  actually came from Stories. Now I post 3 Stories daily instead of spending hours
                  on Reels. Leads doubled."
                </p>
                <div>
              ...
              <div className="p-6 rounded-xl bg-glass-background backdrop-blur-md border border-glass-border">
                <p className="glass-body italic mb-4">
                  "The listing view analytics told me my $2M+ properties get tons of views but zero
                  inquiries. I adjusted my lead forms to pre-qualify high-net-worth buyers. Now I
                  get fewer, but higher-quality leads."
                </p>
                <div>
                ...
                {[
                  {
                    title: 'CSV Export',
                    description:
                      'Download all your analytics data to Excel or Google Sheets for custom analysis',
                  },
                  {
                    title: 'PDF Reports',
                    description:
                      'Generate monthly performance reports to share with your team or broker',
                  },
                  {
                    title: 'Email Summaries',
                    description:
                      'Get weekly/monthly email summaries of your key metrics automatically',
                  },
                ].map((item, i) => (
                  <div
                    key={i}
                    className="p-6 rounded-xl bg-glass-background backdrop-blur-md border border-glass-border text-center"
                  >
        ...
        <section className="py-20 bg-background/50">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl mb-8 glass-body max-w-2xl mx-auto">
              Track what matters, optimize what works, and grow your real estate business with
              confidence
            </p>
            <Link
              to="/auth/register"
...
function MetricCard({
  ...
  return (
    <div className="p-8 rounded-xl bg-glass-background backdrop-blur-md border border-glass-border">
      ...
      <div className="mb-6">
        <h4 className="text-sm font-light text-foreground mb-3 uppercase tracking-wide">
          Metrics Tracked:
        </h4>
