...
export default function AnalyticsDashboard() {
  ...
  const kpis = useMemo(() => calculateKPIs(current, previous), [current, previous]);
  ...
  const handleGenerateReport = async (config: ReportConfig): Promise<any[]> => {
      ...
      {stats.totalViews === 0 && stats.totalLeads === 0 && (
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 text-center">
          ...
          <p className="text-blue-700">
            Start sharing your profile to see analytics data here. Views and leads will be tracked
            automatically.
          </p>
        </div>
      )}
              ...
              <div className="bg-white p-6 rounded-lg border">
                ...
                <ul className="space-y-2 text-sm text-gray-700">
                  <li className="flex items-start gap-2">
                    ...
                    <span>Improve Viewed → Contacted rate with clearer CTAs</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-primary">•</span>
                    <span>Reduce dropoff with faster response times</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-primary">•</span>
                    <span>Qualify leads better with targeted questions</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-primary">•</span>
                    <span>Nurture qualified leads with follow-ups</span>
                  </li>
                </ul>
              </div>
            </div>
