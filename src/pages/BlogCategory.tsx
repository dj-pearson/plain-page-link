...
> = {
  'real-estate-tips': {
    ...
    description:
      "Expert advice and proven strategies for real estate professionals to grow their business, attract more clients, and close more deals. Whether you're a new agent or seasoned professional, these tips will help you succeed in today's competitive market. Learn about marketing strategies, client communication, negotiation tactics, and industry best practices from experienced agents who have built successful careers.",
    metaDescription:
      'Expert real estate tips for agents and professionals. Marketing strategies, client communication, negotiation tactics, and best practices to grow your business.',
    keywords: [
      'real estate tips',
      'agent advice',
  ...
  'market-insights': {
    ...
    description:
      'Stay informed with the latest real estate market trends, data-driven analysis, and economic indicators affecting property values. Our market insights help agents, buyers, and sellers make informed decisions based on current conditions, seasonal patterns, and emerging trends. From housing inventory levels to interest rate impacts, we cover the factors that drive real estate markets locally and nationally.',
    metaDescription:
      'Real estate market insights, trends, and analysis. Housing data, economic indicators, market predictions, and expert analysis for informed real estate decisions.',
    keywords: [
  ...
  'buying-guide': {
    ...
    metaDescription:
      'Complete home buying guide for first-time and experienced buyers. Mortgage tips, home search strategies, offer negotiations, and closing process explained.',
    keywords: [
      'home buying guide',
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'From offer acceptance to closing typically takes 30-45 days for financed purchases. The timeline includes home inspection (7-10 days), appraisal (1-2 weeks), mortgage underwriting (2-3 weeks), and final walk-through. Cash purchases can close in as little as 1-2 weeks. Pre-approval before house hunting can expedite the process significantly.',
      },
      {
        question: 'What should I look for during a home showing?',
        answer:
          "Beyond aesthetics, check for: foundation cracks, roof condition, water damage signs, HVAC age, electrical panel capacity, plumbing condition, window quality, signs of pests, neighborhood noise levels, and natural light. Take notes and photos, test all faucets and appliances, open closets, and don't hesitate to ask questions about age of major systems and recent updates.",
      },
    ],
  },
  'selling-guide': {
    ...
    description:
      "Maximize your home's value and sell faster with expert selling strategies. Our guides cover home staging, pricing strategies, negotiation tactics, and marketing approaches that attract qualified buyers. Learn how to prepare your home for sale, what repairs to make (and skip), how to price competitively, and how to navigate multiple offers. Whether you're selling in a hot market or facing challenges, we provide actionable advice to help you achieve your selling goals and maximize your return on investment.",
    metaDescription:
      "Home selling guide with expert strategies for pricing, staging, marketing, and negotiations. Maximize your home's value and sell faster with proven tactics.",
    keywords: [
      'home selling guide',
      'sell house fast',
      'home staging tips',
  ...
  investment: {
    ...
    metaDescription:
      'Real estate investment guide covering rental properties, fix-and-flip, ROI analysis, financing strategies, and wealth building through property investment.',
    keywords: [
  ...
  'neighborhood-guides': {
    ...
    metaDescription:
      'Comprehensive neighborhood guides with school ratings, amenities, demographics, and lifestyle information. Find the perfect community for your family and budget.',
    keywords: [
      'neighborhood guides',
      'community profiles',
      'best neighborhoods',
  ...
  general: {
    ...
    description:
      "Comprehensive real estate information covering industry news, legal considerations, technology trends, and professional development for agents and consumers. Stay updated on changing regulations, emerging PropTech solutions, market shifts, and best practices in real estate. Whether you're a consumer looking to understand real estate processes or an agent seeking professional growth, these resources provide valuable insights into all aspects of the real estate industry.",
    metaDescription:
      'General real estate information, industry news, legal updates, technology trends, and professional resources for agents and home buyers/sellers.',
    keywords: [
