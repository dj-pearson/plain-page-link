...
export function Hero3DShowpiece({ className = '', height = '600px' }: Hero3DShowpieceProps) {
  ...
  return (
    ...
    >
      ...
      {/* styled-jsx is not a dependency, so this never scoped: it renders a
                plain <style> and the rules below are global. Written as global
                rules now rather than implying a scoping that does not happen. */}
      <style>{`
        .glass-card {
