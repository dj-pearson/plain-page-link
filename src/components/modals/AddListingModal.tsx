        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col flex-1 overflow-hidden">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    A compelling description helps attract more buyers.
                  </p>
                </div>
                <div>
                  ...
                  <Textarea
                    ...
                    {...register('highlights')}
                    rows={3}
                    placeholder="Updated kitchen, Hardwood floors, Pool, Mountain views"
                    className="mt-1"
                  />
                  <p className="text-xs text-muted-foreground mt-1">
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <label htmlFor="image-upload-add" className="cursor-pointer">
                    ...
                    <p className="text-xs text-muted-foreground mt-1">
                      JPEG, PNG, WEBP up to 5MB each (max 25 photos)
                    </p>
                  </label>
                </div>
                {imageError && (
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-4">
                  <div>
                    <Label htmlFor="virtualTourUrl" className="flex items-center gap-2">
                      <Video className="h-4 w-4" /> Virtual Tour URL
                    </Label>
                    <Input
                      id="virtualTourUrl"
                ...
                <div className="mt-6 p-4 bg-green-50 border border-green-200 rounded-lg">
                  <p className="text-sm font-medium text-green-800">
                    Ready to publish! Review and click "Add Listing" to save.
                  </p>
                </div>
              </div>
            )}
          ...
          <div className="px-6 py-4 border-t bg-background flex items-center justify-between">
            <Button
              type="button"
              variant="outline"
              onClick={currentStep === 0 ? handleClose : goToPrevStep}
            >
              {currentStep === 0 ? (
                'Cancel'
              ) : (
