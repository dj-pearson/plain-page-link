...
import { Trash2, Check, Plus, Palette } from 'lucide-react';
            ...
            {savedThemes.map((savedTheme) => (
              <Card
                ...
                className={`cursor-pointer transition-all hover:shadow-md ${
                  activatedThemeId === savedTheme.id ? 'ring-2 ring-primary' : ''
                }`}
                ...
                <CardContent className="p-4">
                  <div className="space-y-3">
                    ...
                    <div className="flex gap-2 h-12 rounded-lg overflow-hidden">
                      {getPreviewColors(savedTheme.theme).map((color, i) => (
                    ...
                    <div>
                      <div className="flex items-start justify-between gap-2">
                        <h4 className="font-semibold text-sm truncate flex-1">{savedTheme.name}</h4>
                      ...
                      <p className="text-xs text-muted-foreground mt-1">
                        {savedTheme.theme.fonts.heading} • {savedTheme.theme.name}
                      </p>
                    </div>
                    ...
                    <div className="flex gap-2 pt-2">
                      ...
                      <Button
                        ...
                        onClick={(e) => {
                          e.stopPropagation();
                          handleDeleteTheme(savedTheme.id, savedTheme.name);
                        }}
