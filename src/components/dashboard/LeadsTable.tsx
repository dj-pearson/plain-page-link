...
interface LeadsTableProps {
  leads: RecentLead[];
  onLeadClick?: (lead: RecentLead) => void;
}
...
export function LeadsTable({ leads, onLeadClick }: LeadsTableProps) {
  ...
  const sortedLeads = [...leads].sort((a, b) => {
    ...
    switch (sortField) {
      case 'created_at':
        // created_at is nullable; an undated lead sorts oldest rather
        // than becoming NaN and leaving the whole order unspecified.
      ...
      case 'lead_type':
        ...
        break;
      case 'status':
        // status is nullable, and .localeCompare on null throws.
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Your latest lead submissions ({leads.length} total)</CardDescription>
      </CardHeader>
      <CardContent>
