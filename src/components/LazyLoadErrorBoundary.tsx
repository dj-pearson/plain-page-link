          ...
          <div className="max-w-lg w-full bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="mb-6 p-4 bg-gray-50 rounded-lg">
              <p className="text-sm text-gray-700">
                {isChunkLoadError ? (
                  <>
                    The application has been updated. Please refresh the page to load the latest
                    version.
                  </>
                ) : (
                  <>
                    An unexpected error occurred while loading this page. This might be due to a
                    network issue or outdated cached files.
                  </>
                )}
              </p>
            </div>
            ...
            {import.meta.env.DEV && this.state.error && (
              <div className="mb-6 p-4 bg-red-50 border border-red-200 rounded-lg">
                <p className="text-xs font-mono text-red-800 mb-1">Development Error Details:</p>
