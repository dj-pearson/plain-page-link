...
export function InsightsWidget({
  ...
  if (viewsGrowth > 20) {
    insights.push({
      ...
      description:
        'Your profile is getting great visibility! Keep sharing your link on social media.',
    });
  }
  ...
  if (leadsGrowth > 15) {
    insights.push({
      ...
      description:
        'Your lead generation is accelerating. Make sure to respond quickly to maintain momentum.',
      action: {
        label: 'Check leads',
  ...
  if (stats.totalViews > 100 && stats.conversionRate < 2) {
    insights.push({
      ...
      description:
        "You're getting views but not many leads. Try adding clear call-to-action buttons.",
      action: {
        label: 'Add CTAs',
  ...
  if (stats.totalViews < 50 && listingsCount > 0) {
    insights.push({
      ...
      description:
        'Share your profile link on Instagram, Facebook, and email signatures to increase traffic.',
    });
  }
  ...
  if (linksCount === 0) {
    insights.push({
      ...
      description:
        'Link to your website, calendar, and social media to give visitors more ways to connect.',
      action: {
        label: 'Add links',
        href: '/dashboard/links',
      },
  ...
  if (stats.totalViews > 0 && stats.totalLeads === 0) {
    insights.push({
      ...
      description:
        'Add contact forms, showcase testimonials, and ensure your phone/email are visible.',
      action: {
        label: 'Edit profile',
  ...
  if (viewsGrowth < -20) {
    insights.push({
      ...
      description:
        'Increase your social media activity and consider updating your listings to boost visibility.',
    });
  }
  ...
  if (insights.length === 0) {
    insights.push({
      ...
      description:
        'Keep your profile updated with fresh listings and share it regularly to maintain growth.',
    });
  }
      ...
      <CardContent>
        <div className="space-y-3">
          {insights.slice(0, 5).map((insight) => (
            <div key={insight.id} className={`p-4 rounded-lg border ${getBgColor(insight.type)}`}>
