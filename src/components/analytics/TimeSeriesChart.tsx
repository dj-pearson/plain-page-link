...
export function TimeSeriesChart({
  ...
  const createPath = (dataPoints: TimeSeriesData[], _dashed: boolean = false) => {
      ...
      >
        ...
        <g className="grid-lines">
          {[0, 25, 50, 75, 100].map((percent) => {
            ...
            return (
              <g key={percent}>
                <line x1={40} y1={y} x2={760} y2={y} stroke="#e5e7eb" strokeWidth={1} />
                <text x={25} y={y + 4} fontSize={10} fill="#6b7280" textAnchor="end">
        ...
        {/* Area fill */}
        <path d={createAreaPath(actualData)} fill={color} fillOpacity={0.1} />
