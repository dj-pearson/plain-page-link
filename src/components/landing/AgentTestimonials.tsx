import { TrendingUp, Clock, Shield, Smartphone, BarChart3, Users } from 'lucide-react';
  ...
  const benefits = [
    {
      ...
      description:
        'Pre-qualification forms, smart contact routing, and lead capture designed specifically for real estate. Every element optimized to convert visitors into qualified leads.',
    ...
    },
    {
      ...
      description:
        'Import your listings, add your credentials, and publish your professional profile. No technical skills required - just enter your information and go live.',
    ...
    },
    {
      ...
      description:
        'Display your license, brokerage, sold properties, and certifications. Build trust with verified credentials that set you apart from the competition.',
    ...
    },
    {
      ...
      description:
        'Your profile looks perfect on any device. Optimized for Instagram, Facebook, and social media sharing where your clients spend their time.',
    ...
    },
    {
      ...
      description:
        'See which listings get the most views, where your leads come from, and track your conversion performance. Data you can actually use.',
    ...
    },
    {
      ...
      description:
        'Capture buyer inquiries, seller leads, and home valuation requests in one place. Follow up faster with organized lead tracking.',
      ...
      <div className="container mx-auto px-4">
        <header className="text-center mb-16">
          ...
          <p className="text-xl glass-body max-w-2xl mx-auto">
            Everything you need to capture leads and showcase your expertise in one professional
            profile
          </p>
        </header>
