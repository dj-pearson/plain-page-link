...
import { Search, Mail, Phone, Clock, MessageSquare, TrendingUp, MapPin } from 'lucide-react';
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-600 mt-1">
            {stats.new} new leads • {stats.hot} hot • Avg score: {stats.avgScore}
          </p>
        </div>
...
function LeadCard({ lead, onClick, onQuickReply, onMarkAsRead }: LeadCardProps) {
        ...
        <div className="flex-1 min-w-0">
          ...
          {lead.listingTitle && (
            <p className="text-xs text-gray-500">
              Interested in: <span className="font-medium">{lead.listingTitle}</span>
            </p>
          )}
