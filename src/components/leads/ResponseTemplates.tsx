      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        {filteredTemplates.map((template) => (
          <TemplateCard
            ...
            onEdit={
              onUpdateTemplate ? (updates) => onUpdateTemplate(template.id, updates) : undefined
            }
...
function TemplateCard({ template, onUse, onEdit, onDelete }: TemplateCardProps) {
  ...
  return (
    <div className="p-4 border rounded-lg hover:shadow-md transition-shadow">
      ...
      <p className="text-sm text-gray-700 line-clamp-3 mb-3">{template.body}</p>
    ...
    <div className="space-y-4">
      ...
      <div>
        ...
        <p className="text-xs text-gray-500 mt-1">
          Use curly braces for variables: {'{leadName}'}, {'{listingAddress}'}, {'{price}'}
        </p>
      </div>
