      ...
      <Card className="border-green-200 bg-green-50">
        <CardContent className="pt-6">
          <div className="flex flex-col items-center text-center space-y-4">
            ...
            <div>
              <h3 className="text-lg font-semibold text-green-900">Valuation Request Received!</h3>
              <p className="text-sm text-green-700 mt-1">
                {agentName} will send you a detailed home valuation report within 24 hours.
              </p>
            </div>
          </div>
        </CardContent>
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Find out what your home is worth in today's market with {agentName}
        </CardDescription>
      </CardHeader>
      <CardContent>
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              {errors.condition && (
                <p className="text-sm text-red-500 font-medium">{errors.condition.message}</p>
              )}
            </div>
          </div>
