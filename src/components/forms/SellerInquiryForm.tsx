          ...
          <div className="flex flex-col items-center text-center space-y-4">
            ...
            <div>
              ...
              <p className="text-sm text-green-700 mt-1">
                {agentName} will contact you within 24 hours to discuss selling your home.
              </p>
            </div>
          </div>
        </CardContent>
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Get a competitive market analysis from {agentName}</CardDescription>
      </CardHeader>
      <CardContent>
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          {error && (
            ...
            >
              ...
              <div className="flex-1">
                <h4 className="font-semibold text-red-900 text-sm">Submission Error</h4>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="space-y-2">
              ...
              {errors.propertyType && (
                <p className="text-sm text-red-500 font-medium">{errors.propertyType.message}</p>
              )}
            </div>
            ...
            <div className="space-y-2">
              ...
              {errors.bedrooms && (
                <p className="text-sm text-red-500 font-medium">{errors.bedrooms.message}</p>
              )}
            </div>
            ...
            <div className="space-y-2">
              ...
              <Select
                onValueChange={(value) => setValue('bathrooms', value, { shouldValidate: true })}
              >
              ...
              {errors.bathrooms && (
                <p className="text-sm text-red-500 font-medium">{errors.bathrooms.message}</p>
              )}
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              <Label htmlFor="timeline">
                When are you selling? <span className="text-red-500">*</span>
              </Label>
              <Select
              ...
              >
                ...
                <SelectContent>
                  <SelectItem value="immediate">ASAP (0-30 days)</SelectItem>
              ...
              {errors.timeline && (
                <p className="text-sm text-red-500 font-medium">{errors.timeline.message}</p>
              )}
            </div>
            ...
            <div className="space-y-2">
              ...
              {errors.reason && (
                <p className="text-sm text-red-500 font-medium">{errors.reason.message}</p>
              )}
            </div>
          </div>
