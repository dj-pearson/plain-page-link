...
export function BuyerInquiryForm({
  ...
  const onSubmit = async (data: BuyerFormData) => {
    ...
    try {
      ...
      logger.error('Error submitting buyer inquiry', error as Error);
      const errorMessage =
      ...
      <Card className="border-green-200 bg-green-50">
        <CardContent className="pt-6">
          <div className="flex flex-col items-center text-center space-y-4">
            ...
            <div>
              <h3 className="text-lg font-semibold text-green-900">Inquiry Received!</h3>
              <p className="text-sm text-green-700 mt-1">
                {agentName} will contact you within 24 hours to discuss your home search.
              </p>
            </div>
          </div>
        </CardContent>
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Let {agentName} help you find the perfect property</CardDescription>
      </CardHeader>
      <CardContent>
          ...
          <div className="space-y-2">
            ...
            <Select onValueChange={(value) => setValue('preApproved', value)}>
              ...
              <SelectContent>
                ...
                <SelectItem value="not-yet">Not yet, need help</SelectItem>
