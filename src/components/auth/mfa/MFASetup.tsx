        ...
        <div className="space-y-6">
          ...
          <div className="flex justify-center">
            <div className="bg-white p-4 rounded-lg shadow-sm border">
              {/*
                Rendered locally with qrcode.react so the TOTP shared secret
                never leaves the browser (previously sent to a third-party QR
                image API, which leaked the 2FA secret).
              */}
              <QRCodeSVG
