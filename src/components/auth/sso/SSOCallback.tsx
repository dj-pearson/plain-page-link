      ...
      try {
        ...
        if (result.success) {
          ...
          if (result.redirectUrl) {
            ...
            const safeRedirectUrl = sanitizeRedirectUrl(result.redirectUrl, '/dashboard', [
              '*.agentbio.net',
              'localhost:8080',
              '127.0.0.1:8080',
            ]);
      ...
      <div className="w-full max-w-md text-center">
        ...
        {status === 'csrf_error' && (
          <div className="space-y-4">
            ...
            <h2 className="text-xl font-semibold text-gray-900">Security Check Failed</h2>
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 mt-4 text-left">
              ...
              <p className="text-sm text-amber-700 mt-1">
                This security check protects against cross-site request forgery attacks. This can
                happen if:
              </p>
