...
serve(async (req) => {
  ...
  // verify_jwt is disabled, so enforce the service-role key in code — otherwise
  // any anonymous caller could post an attacker-supplied customMessage to a
  // user's configured Slack/webhook for a known alertId.
